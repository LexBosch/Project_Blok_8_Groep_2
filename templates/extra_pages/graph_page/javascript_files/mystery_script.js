!function (e, t) {
    ...
    var a = "undefined" == typeof window ? null : window, o = a ? a.navigator : null, s = (a && a.document, e("")),
        l = e({}), u = e(function () {
        }), c = "undefined" == typeof HTMLElement ? "undefined" : e(HTMLElement), h = function (e) {
            ...
            var n = function n() {
                var r, i = arguments, a = t.apply(this, i), o = n.cache;
            ...
            return (f(e) ? e : null) || function (e) {
                ...
                if (c) {
                    ...
                    if (0 === r) o = s = l = Math.round(255 * i); else {
                        var h = i < .5 ? i * (1 + r) : i + r - i * r, d = 2 * i - h;
    ...
    var F = "Expected a function", V = NaN, q = "[object Symbol]", j = /^\s+|\s+$/g, Y = /^[-+]0x[0-9a-f]+$/i,
        X = /^0b[01]+$/i, W = /^0o[0-7]+$/i, H = parseInt, K = "object" == typeof R && R && R.Object === Object && R,
        G = "object" == typeof self && self && self.Object === Object && self, Z = K || G || Function("return this")(),
        U = Object.prototype.toString, $ = Math.max, Q = Math.min, J = function () {
            return Z.Date.now()
        };
    ...
    function te(e) {
        ...
        e = e.replace(j, "");
        var n = X.test(e);
        return n || W.test(e) ? H(e.slice(2), n ? 2 : 8) : Y.test(e) ? V : +e
    }

    var ne = function (e, t, n) {
            var r, i, a, o, s, l, u = 0, c = !1, h = !1, d = !0;
        ...
        }, re = a ? a.performance : null, ie = re && re.now ? function () {
            return re.now()
        } : function () {
            return Date.now()
        }, ae = function () {
        ...
        me = function () {
        ...
        }(), Ae = "undefined" !== ("undefined" == typeof Set ? "undefined" : e(Set)) ? Set : Le, Oe = function (e, t, n) {
            ...
            return e = {bfs: e.bfs || !e.dfs, dfs: e.dfs || !e.bfs}, function (t, n, r) {
                ...
                var C = function () {
                    ...
                    var o, s = h[i], d = c[i], p = null != d ? d.source() : null, g = null != d ? d.target() : null,
                    ...
                    for (var m = t.connectedEdges().filter(function (e) {
                        ...
                        var E = m[w], k = E.connectedNodes().filter(function (e) {
    ...
    var Ve = function (e, t) {
        ...
        dijkstra: function (e) {
            ...
            var n = qe(e), r = n.root, i = n.weight, a = n.directed, o = this, s = i,
                l = d(r) ? this.filter(r)[0] : r[0], u = {}, c = {}, h = {}, p = this.byGroup(), f = p.nodes,
                v = p.edges;
            ...
            for (var E = function (e, t) {
                ...
                if (h[S] = C, C !== 1 / 0) for (var D = k.neighborhood().intersect(f), P = 0; P < D.length; P++) {
            ...
            return {
                distanceTo: function (e) {
                    ...
                    var t = d(e) ? f.filter(e)[0] : e[0], n = [], r = t, i = r.id();
        ...
        kruskal: function (e) {
            ...
            for (var u = r.sort(function (t, n) {
                ...
                var h = u[c], d = h.source()[0], p = h.target()[0], f = s(d), g = s(p), v = a[f], y = a[g];
        ...
        aStar: function (e) {
            ...
            var l, u, c = r.id(), h = i.id(), d = {}, p = {}, f = {}, g = new Ve(function (e, t) {
            ...
            for (var x, w = 0; g.size() > 0;) {
                if (l = g.pop(), u = l.id(), v.delete(u), w++, u === h) {
                    ...
                    return {found: !0, distance: d[u], path: this.spawn(E), steps: w}
                }
                f[u] = !0;
        ...
        bellmanFord: function (e) {
            var t = this, n = Ge(e), r = n.weight, i = n.directed, a = n.root, o = r, s = this, l = this.cy(),
                u = this.byGroup(), c = u.edges, h = u.nodes, p = h.length, f = new ze, g = !1;
        ...
        kargerStein: function () {
            var e = this.byGroup(), t = e.nodes, n = e.edges;
            n.unmergeBy(function (e) {
                return e.isLoop()
            });
            var r = t.length, i = n.length, a = Math.ceil(Math.pow(Math.log(r) / Math.LN2, 2)), o = Math.floor(r / Ue);
            if (!(r < 2)) {
                for (var s = [], l = 0; l < i; l++) {
                    var u = n[l];
                ...
                for (var c = 1 / 0, h = [], d = new Array(r), p = new Array(r), f = new Array(r), g = function (e, t) {
                    ...
                    var m = Qe(p, s.slice(), r, o), b = m.slice();
                    g(p, f);
                    var x = Qe(p, m, o, 2), w = Qe(f, b, o, 2);
                ...
                return {cut: E, partition1: k, partition2: C}
            }
    ...
    }, ct = Math.log2 || function (e) {
        return Math.log(e) / Math.log(2)
    }, ht = function (e) {
        return e > 0 ? 1 : e < 0 ? -1 : 0
    }, dt = function (e, t) {
        return Math.sqrt(pt(e, t))
    }, pt = function (e, t) {
        ...
        return {x: gt(e.x, t.x, n.x, r), y: gt(e.y, t.y, n.y, r)}
    }, yt = function (e, t, n, r) {
        var i = t.x - e.x, a = t.y - e.y, o = dt(e, t), s = i / o, l = a / o;
        ...
        var s, l = Qt(i, a), u = i / 2, c = a / 2, h = r - c - o;
        if ((s = Ht(e, t, n, r, n - u + l - o, h, n + u - l + o, h, !1)).length > 0) return s;
        var d = n + u + o;
        if ((s = Ht(e, t, n, r, d, r - c + l - o, d, r + c - l + o, !1)).length > 0) return s;
        var p = r + c + o;
        if ((s = Ht(e, t, n, r, n - u + l - o, p, n + u - l + o, p, !1)).length > 0) return s;
        var f, g = n - u - o;
        if ((s = Ht(e, t, n, r, g, r - c + l - o, g, r + c - l + o, !1)).length > 0) return s;
        var v = n - u + l, y = r - c + l;
        if ((f = Xt(e, t, n, r, v, y, l + o)).length > 0 && f[0] <= v && f[1] <= y) return [f[0], f[1]];
        var m = n + u - l, b = r - c + l;
        if ((f = Xt(e, t, n, r, m, b, l + o)).length > 0 && f[0] >= m && f[1] <= b) return [f[0], f[1]];
        var x = n + u - l, w = r + c - l;
        if ((f = Xt(e, t, n, r, x, w, l + o)).length > 0 && f[0] >= x && f[1] >= w) return [f[0], f[1]];
        var E = n - u + l, k = r + c - l;
        return (f = Xt(e, t, n, r, E, k, l + o)).length > 0 && f[0] <= E && f[1] >= k ? [f[0], f[1]] : []
    }, Nt = function (e, t, n, r, i, a, o) {
        var s = o, l = Math.min(n, i), u = Math.max(n, i), c = Math.min(r, a), h = Math.max(r, a);
        return l - s <= e && e <= u + s && c - s <= t && t <= h + s
    }, It = function (e, t, n, r, i, a, o, s, l) {
        var u = Math.min(n, o, i) - l, c = Math.max(n, o, i) + l, h = Math.min(r, s, a) - l, d = Math.max(r, s, a) + l;
        ...
        var a, o, s, l, u, c, h, d;
        return s = -27 * (r /= e) + (t /= e) * (9 * (n /= e) - t * t * 2), a = (o = (3 * n - t * t) / 9) * o * o + (s /= 54) * s, i[1] = 0, h = t / 3, a > 0 ? (u = (u = s + Math.sqrt(a)) < 0 ? -Math.pow(-u, 1 / 3) : Math.pow(u, 1 / 3), c = (c = s - Math.sqrt(a)) < 0 ? -Math.pow(-c, 1 / 3) : Math.pow(c, 1 / 3), i[0] = -h + u + c, h += (u + c) / 2, i[4] = i[2] = -h, h = Math.sqrt(3) * (-c + u) / 2, i[3] = h, void(i[5] = -h)) : (i[5] = i[3] = 0, 0 === a ? (d = s < 0 ? -Math.pow(-s, 1 / 3) : Math.pow(s, 1 / 3), i[0] = 2 * d - h, void(i[4] = i[2] = -(d + h))) : (l = (o = -o) * o * o, l = Math.acos(s / Math.sqrt(l)), d = 2 * Math.sqrt(o), i[0] = -h + d * Math.cos(l / 3), i[2] = -h + d * Math.cos((l + 2 * Math.PI) / 3), void(i[4] = -h + d * Math.cos((l + 4 * Math.PI) / 3))))
    }, At = function (e, t, n, r, i, a, o, s) {
        var l = [];
        Lt(1 * n * n - 4 * n * i + 2 * n * o + 4 * i * i - 4 * i * o + o * o + r * r - 4 * r * a + 2 * r * s + 4 * a * a - 4 * a * s + s * s, 9 * n * i - 3 * n * n - 3 * n * o - 6 * i * i + 3 * i * o + 9 * r * a - 3 * r * r - 3 * r * s - 6 * a * a + 3 * a * s, 3 * n * n - 6 * n * i + n * o - n * e + 2 * i * i + 2 * i * e - o * e + 3 * r * r - 6 * r * a + r * s - r * t + 2 * a * a + 2 * a * t - s * t, 1 * n * i - n * n + n * e - i * e + r * a - r * r + r * t - a * t, l);
        ...
        for (var n, r, i, a, o = new Array(2 * e.length), s = 0; s < e.length / 2; s++) {
            ...
            var l = a - r, u = -(i - n), c = Math.sqrt(l * l + u * u), h = l / c, d = u / c;
        ...
        if (h < 0) return [];
        var d = (-c + Math.sqrt(h)) / (2 * u), p = (-c - Math.sqrt(h)) / (2 * u), f = Math.min(d, p),
            g = Math.max(d, p), v = [];
    ...
    }, Ht = function (e, t, n, r, i, a, o, s, l) {
        var u = e - i, c = n - e, h = o - i, d = t - a, p = r - t, f = s - a, g = h * d - f * u, v = c * d - p * u,
            y = f * c - h * p;
        if (0 !== y) {
            var m = g / y, b = v / y;
            return -.001 <= m && m <= 1.001 && -.001 <= b && b <= 1.001 ? [e + m * c, t + m * p] : l ? [e + m * c, t + m * p] : []
        }
        return 0 === g || 0 === v ? Wt(e, n, o) === o ? [o, s] : Wt(e, n, i) === i ? [i, a] : Wt(i, o, n) === n ? [n, r] : [] : []
    }, Kt = function (e, t, n, r, i, a, o, s) {
        var l, u, c, h, d, p, f = [], g = new Array(n.length), v = !0;
        if (null == a && (v = !1), v) {
        ...
        for (var b = 0; b < u.length / 2; b++) c = u[2 * b], h = u[2 * b + 1], b < u.length / 2 - 1 ? (d = u[2 * (b + 1)], p = u[2 * (b + 1) + 1]) : (d = u[0], p = u[1]), 0 !== (l = Ht(e, t, r, i, c, h, d, p)).length && f.push(l[0], l[1]);
        return f
    }, Gt = function (e, t, n) {
        ...
        if (a < -1) for (var d = 0; d < r; d++) n = e[2 * d + 1] = e[2 * d + 1] + (-1 - a);
        return e
    }, $t = function (e, t) {
        ...
        pageRank: function (e) {
            for (var t = tn(e), n = t.dampingFactor, r = t.precision, i = t.iterations, a = t.weight, o = this._private.cy, s = this.byGroup(), l = s.nodes, u = s.edges, c = l.length, h = c * c, d = u.length, p = new Array(h), f = new Array(c), g = (1 - n) / c, v = 0; v < c; v++) {
                for (var y = 0; y < c; y++) {
                    p[v * c + y] = 0
                }
                f[v] = 0
        ...
        degreeCentralityNormalized: function (e) {
            ...
            if (i = t.collection(i)[0], o) {
                ...
                return {indegree: Math.pow(h, 1 - s) * Math.pow(p, s), outdegree: Math.pow(d, 1 - s) * Math.pow(f, s)}
            }
    ...
    an.dc = an.degreeCentrality, an.dcn = an.degreeCentralityNormalised = an.degreeCentralityNormalized;
    var on = Me({
        ...
        closenessCentralityNormalized: function (e) {
            for (var t = on(e), n = t.harmonic, r = t.weight, i = t.directed, a = this.cy(), o = {}, s = 0, l = this.nodes(), u = this.floydWarshall({
                weight: r,
                directed: i
            }), c = 0; c < l.length; c++) {
                for (var h = 0, p = l[c], f = 0; f < l.length; f++) if (c !== f) {
            ...
            var t = on(e), n = t.root, r = t.weight, i = t.directed, a = t.harmonic;
            n = this.filter(n)[0];
    ...
    sn.cc = sn.closenessCentrality, sn.ccn = sn.closenessCentralityNormalised = sn.closenessCentralityNormalized;
    var ln = Me({weight: null, directed: !1}), un = {
        betweennessCentrality: function (e) {
            for (var t = ln(e), n = t.directed, r = t.weight, i = null != r, a = this.cy(), o = this.nodes(), s = {}, l = {}, u = 0, c = function (e, t) {
                l[e] = t, t > u && (u = t)
            }, h = function (e) {
                return l[e]
            }, d = 0; d < o.length; d++) {
            ...
            for (var g = function (e) {
                for (var t = o[e].id(), n = [], l = {}, u = {}, d = {}, p = new Ve(function (e, t) {
                    return d[e] - d[t]
                }), f = 0; f < o.length; f++) {
                    var g = o[f].id();
                    l[g] = [], u[g] = 0, d[g] = 1 / 0
                ...
                for (; n.length > 0;) for (var D = n.pop(), P = 0; P < l[D].length; P++) {
                    var T = l[D][P];
    ...
    un.bc = un.betweennessCentrality;
    var cn = Me({
        ...
        for (var r = e.slice(0), i = 1; i < n; i++) e = pn(e, r, t);
        return e
    }, gn = function (e, t, n) {
        ...
        for (var d = 0; d < n.length; d++) {
            var p = n[d], f = a[p.source().id()], g = a[p.target().id()], v = hn(p, i.attributes);
            c[f * l + g] += v, c[g * l + f] += v
        }
        !function (e, t, n) {
            for (var r = 0; r < t; r++) e[r * t + r] = n
        }(c, l, i.multFactor), dn(c, l);
        for (var y = !0, m = 0; y && m < i.maxIterations;) y = !1, s = fn(c, l, i.expandFactor), c = gn(s, l, i.inflateFactor), vn(c, s, u, 4) || (y = !0), m++;
        ...
        return b = function (e) {
            for (var t = 0; t < e.length; t++) for (var n = 0; n < e.length; n++) t != n && yn(e[t], e[n]) && e.splice(n, 1);
            return e
        }(b)
    }, bn = {markovClustering: mn, mcl: mn}, xn = function (e) {
        return e
    }, wn = function (e, t) {
        return Math.abs(t - e)
    }, En = function (e, t, n) {
        ...
        return Math.max(e, wn(t, n))
    }, Dn = function (e, t, n, r, i) {
        for (var a = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : xn, o = r, s = 0; s < e; s++) o = i(o, t(s), n(s));
        return a(o)
    }, Pn = {
        euclidean: function (e, t, n) {
            return e >= 2 ? Dn(e, t, n, 0, kn, Cn) : Dn(e, t, n, 0, En)
        }, squaredEuclidean: function (e, t, n) {
            return Dn(e, t, n, 0, kn)
        }, manhattan: function (e, t, n) {
            return Dn(e, t, n, 0, En)
        }, max: function (e, t, n) {
            return Dn(e, t, n, -1 / 0, Sn)
        }
    };
    ...
    var Mn = Me({
        ...
        return Tn(e, r.length, a, function (e) {
            return r[e](t)
        }, o, s)
    }, Nn = function (e, t, n) {
        ...
        if (e.length < 50) for (var r = 0; r < t; r++) {
            for (var i = e[Math.floor(Math.random() * e.length)]; An(i, n, r);) i = e[Math.floor(Math.random() * e.length)];
            n[r] = i
        } else for (var a = 0; a < t; a++) n[a] = e[Math.floor(Math.random() * e.length)];
        return n
    }, Rn = function (e, t, n) {
        for (var r = 0, i = 0; i < t.length; i++) r += _n("manhattan", t[i], e, n, "kMedoids");
        return r
        ...
        for (var o, s, l, u = 2 / (i.m - 1), c = 0; c < n.length; c++) for (var h = 0; h < r.length; h++) {
            o = 0;
            for (var d = 0; d < n.length; d++) s = _n(i.distance, r[h], n[c], i.attributes, "cmeans"), l = _n(i.distance, r[h], n[d], i.attributes, "cmeans"), o += Math.pow(s / l, u);
            e[h][c] = 1 / o
        }
    }, qn = function (e) {
        ...
        for (var v = !0, y = 0; v && y < s.maxIterations;) v = !1, Fn(t, o, n, i, s), Vn(n, r, t, o, s), Ln(n, r, s.sensitivityThreshold) || (v = !0), y++;
        return {
        ...
        kMeans: function (t) {
            ...
            o.testMode ? "number" == typeof o.testCentroids ? (o.testCentroids, n = Nn(i, o.k, o.attributes)) : n = "object" === e(o.testCentroids) ? o.testCentroids : Nn(i, o.k, o.attributes) : n = Nn(i, o.k, o.attributes);
            ...
            var n, r, i = this.cy(), a = this.nodes(), o = null, s = Bn(t), l = new Array(s.k), u = {},
                c = new Array(s.k);
            s.testMode ? "number" == typeof s.testCentroids || (n = "object" === e(s.testCentroids) ? s.testCentroids : On(a, s.k)) : n = On(a, s.k);
            for (var h = !0, d = 0; h && d < s.maxIterations;) {
                ...
                for (var f = 0; f < n.length; f++) {
                    var g = zn(f, a, u);
                    if (0 !== g.length) {
                        c[f] = Rn(n[f], g, s.attributes);
                        for (var v = 0; v < g.length; v++) (r = Rn(g[v], g, s.attributes)) < c[f] && (c[f] = r, n[f] = g[v], h = !0);
                        l[f] = i.collection(g)
                    }
                }
                d++
        ...
        dendrogramDepth: 0,
        attributes: []
    }), Xn = {single: "min", complete: "max"}, Wn = function (e, t, n, r, i) {
        for (var a, o = 0, s = 1 / 0, l = i.attributes, u = function (e, t) {
            return Tn(i.distance, l.length, function (t) {
                return l[t](e)
            }, function (e) {
                return l[e](t)
            }, e, t)
        }, c = 0; c < e.length; c++) {
            var h = e[c].key, d = n[h][r[h]];
            d < s && (o = h, s = d)
        }
        ...
        t && (t.value ? n.push(t.value) : (t.left && e(t.left, n, r), t.right && e(t.right, n, r)))
    }, Kn = function (e) {
        for (var t = this.cy(), n = this.nodes(), r = function (e) {
            var t = Yn(e), n = Xn[t.linkage];
            return null != n && (t.linkage = n), t
        }(e), i = r.attributes, a = function (e, t) {
            return Tn(r.distance, i.length, function (t) {
                return i[t](e)
            }, function (e) {
                return i[e](t)
            }, e, t)
        }, o = [], s = [], l = [], u = [], c = 0; c < n.length; c++) {
            var h = {value: "dendrogram" === r.mode ? n[c] : [n[c]], key: c, index: c};
            o[c] = h, u[c] = h, s[c] = [], l[c] = 0
        }
        for (var d = 0; d < o.length; d++) for (var p = 0; p <= d; p++) {
            var f = void 0;
        ...
        return "dendrogram" === r.mode ? (g = function e(t, n, r) {
            if (!t) return [];
            var i = [], a = [], o = [];
            return 0 === n ? (t.left && Hn(t.left, i, r), t.right && Hn(t.right, a, r), o = i.concat(a), [r.collection(o)]) : 1 === n ? t.value ? [r.collection(t.value)] : (t.left && Hn(t.left, i, r), t.right && Hn(t.right, a, r), [r.collection(i), r.collection(a)]) : t.value ? [r.collection(t.value)] : (t.left && (i = e(t.left, n - 1, r)), t.right && (a = e(t.right, n - 1, r)), i.concat(a))
    ...
    }, Gn = {hierarchicalClustering: Kn, hca: Kn}, Zn = Me({
        distance: "euclidean",
        preference: "median",
        damping: .8,
        maxIterations: 1e3,
        ...
        return -Tn(e, r.length, function (e) {
            return i(t, e)
        }, function (e) {
            return i(n, e)
        }, t, n)
    }, $n = function (e, t) {
        return "median" === t ? st(e) : "mean" === t ? ot(e) : "min" === t ? it(e) : "max" === t ? at(e) : t
    }, Qn = function (e, t, n) {
        for (var r = [], i = 0; i < e; i++) {
        ...
        for (var p = 0; p < t; p++) for (var f = 0; f < t; f++) p !== f && (r[p * t + f] = Un(u.distance, l[p], l[f], u.attributes));
        i = $n(r, u.preference);
    ...
    [Fe, je, Ye, We, Ke, Ze, Je, nn, an, sn, un, bn, jn, Gn, {affinityPropagation: Jn, ap: Jn}].forEach(function (e) {
        I(er, e)
    });
    var tr = function e(t) {
    ...
    tr.prototype = {
        fulfill: function (e) {
            return nr(this, 1, "fulfillValue", e)
        }, reject: function (e) {
            return nr(this, 2, "rejectReason", e)
        }, then: function (e, t) {
            var n = new tr;
            return this.onFulfilled.push(ar(e, n, "fulfill")), this.onRejected.push(ar(t, n, "reject")), rr(this), n.proxy
        }
    };
    var nr = function (e, t, n, r) {
        return 0 === e.state && (e.state = t, e[n] = r, rr(e)), e
    }, rr = function (e) {
        1 === e.state ? ir(e, "onFulfilled", e.fulfillValue) : 2 === e.state && ir(e, "onRejected", e.rejectReason)
    }, ir = function (e, t, n) {
        if (0 !== e[t].length) {
            var r = e[t];
            e[t] = [];
    ...
    }, tr.resolve = function (e) {
        return new tr(function (t, n) {
            t(e)
        })
    }, tr.reject = function (e) {
        return new tr(function (t, n) {
            n(e)
        })
    };
    var sr = "undefined" != typeof Promise ? Promise : tr, lr = function (e, t, n) {
        var r = w(e), i = !r, a = this._private = I({duration: 1e3}, t, n);
    ...
    }), ur.complete = ur.completed, ur.run = ur.play, ur.running = ur.playing;
    var cr = {};
    [{
        animated: function () {
            return function () {
            ...
            return function (e, t) {
                ...
                var s = i.style();
                if (e = I({}, e, t), 0 === Object.keys(e).length) return new lr(r[0], e);
                ...
                if (a && null != e.panBy) {
                    var h = e.panBy, d = i.pan();
                    e.pan = {x: d.x + h.x, y: d.y + h.y}
                }
        ...
        data: function (e) {
            return e = I({}, {
                ...
                var r = e, i = void 0 !== this.length, a = i ? this : [this], o = i ? this[0] : this;
                if (d(t)) {
                    var s;
                    ...
                    var f, v, y = t, m = Object.keys(y);
                    r.beforeSet(this, y);
                    for (var b = 0; b < m.length; b++) {
                        if (v = y[f = m[b]], !r.immutableKeys[f]) for (var x = 0; x < a.length; x++) {
                            var w = a[x];
            ...
            return e = I({}, {
                ...
                if (d(t)) {
                    for (var i = t.split(/\s+/), a = i.length, o = 0; o < a; o++) {
                        var s = i[o];
                        if (!k(s)) if (!n.immutableKeys[s]) for (var l = 0, u = r.length; l < u; l++) r[l]._private[n.field][s] = void 0
                    }
                    n.triggerEvent && this[n.triggerFnName](n.event)
                } else if (void 0 === t) {
                    for (var c = 0, h = r.length; c < h; c++) for (var p = r[c]._private[n.field], f = Object.keys(p), g = 0; g < f.length; g++) {
                        var v = f[g];
    ...
    var hr = {
        ...
        clearQueue: cr.clearQueue(),
        delay: cr.delay(),
        delayAnimation: cr.delayAnimation(),
        stop: cr.stop()
    }, dr = {
        classes: function (e) {
            if (void 0 === e) {
    ...
    dr.className = dr.classNames = dr.classes;
    var pr = {
        metaChar: "[\\!\\\"\\#\\$\\%\\&\\'\\(\\)\\*\\+\\,\\.\\/\\:\\;\\<\\=\\>\\?\\@\\[\\]\\^\\`\\{\\|\\}\\~]",
        comparatorOp: "=|\\!=|>|>=|<|<=|\\$=|\\^=|\\*=",
        boolOp: "\\?|\\!|\\^",
    ...
    pr.variable = "(?:[\\w-]|(?:\\\\" + pr.metaChar + "))+", pr.value = pr.string + "|" + pr.number, pr.className = pr.variable, pr.id = pr.variable, function () {
        var e, t, n;
        for (e = pr.comparatorOp.split("|"), n = 0; n < e.length; n++) t = e[n], pr.comparatorOp += "|@" + t;
        for (e = pr.comparatorOp.split("|"), n = 0; n < e.length; n++) (t = e[n]).indexOf("!") >= 0 || "=" !== t && (pr.comparatorOp += "|\\!" + t)
    }();
    var fr = 0, gr = 1, vr = 2, yr = 3, mr = 4, br = 5, xr = 6, wr = 7, Er = 8, kr = 9, Cr = 10, Sr = 11, Dr = 12,
        Pr = 13, Tr = 14, Mr = 15, Br = 16, _r = 17, Nr = 18, Ir = 19, zr = 20, Lr = [{
            ...
            for (var e, t = {}, n = 0; n < Lr.length; n++) t[(e = Lr[n]).selector] = e.matches;
            return t
        }(), Or = "(" + Lr.map(function (e) {
            return e.selector
        }).join("|") + ")", Rr = function (e) {
            return e.replace(new RegExp("\\\\(" + pr.metaChar + ")", "g"), function (e, t) {
                return t
            })
        }, Fr = function (e, t, n) {
            e[e.length - 1] = n
        }, Vr = [{
            name: "group", query: !0, regex: "(" + pr.group + ")", populate: function (e, t, n) {
                var r = i(n, 1)[0];
                t.checks.push({type: fr, value: "*" === r ? r : r + "s"})
            }
        }, {
            name: "state", query: !0, regex: Or, populate: function (e, t, n) {
                var r = i(n, 1)[0];
                t.checks.push({type: wr, value: r})
            }
        }, {
            name: "id", query: !0, regex: "\\#(" + pr.id + ")", populate: function (e, t, n) {
                var r = i(n, 1)[0];
                t.checks.push({type: Er, value: Rr(r)})
            }
        }, {
            name: "className", query: !0, regex: "\\.(" + pr.className + ")", populate: function (e, t, n) {
                var r = i(n, 1)[0];
                t.checks.push({type: kr, value: Rr(r)})
            }
        }, {
            name: "dataExists", query: !0, regex: "\\[\\s*(" + pr.variable + ")\\s*\\]", populate: function (e, t, n) {
                var r = i(n, 1)[0];
                t.checks.push({type: mr, field: Rr(r)})
            }
        }, {
            name: "dataCompare",
            query: !0,
            regex: "\\[\\s*(" + pr.variable + ")\\s*(" + pr.comparatorOp + ")\\s*(" + pr.value + ")\\s*\\]",
            populate: function (e, t, n) {
                var r = i(n, 3), a = r[0], o = r[1], s = r[2];
                s = null != new RegExp("^" + pr.string + "$").exec(s) ? s.substring(1, s.length - 1) : parseFloat(s), t.checks.push({
                    type: yr,
                    field: Rr(a),
                    operator: o,
                    value: s
            ...
            name: "dataBool",
            query: !0,
            regex: "\\[\\s*(" + pr.boolOp + ")\\s*(" + pr.variable + ")\\s*\\]",
            populate: function (e, t, n) {
                var r = i(n, 2), a = r[0], o = r[1];
                t.checks.push({type: br, field: Rr(o), operator: a})
            }
        }, {
            name: "metaCompare",
            query: !0,
            regex: "\\[\\[\\s*(" + pr.meta + ")\\s*(" + pr.comparatorOp + ")\\s*(" + pr.number + ")\\s*\\]\\]",
            populate: function (e, t, n) {
                var r = i(n, 3), a = r[0], o = r[1], s = r[2];
                t.checks.push({type: xr, field: Rr(a), operator: o, value: parseFloat(s)})
            }
        }, {
            name: "nextQuery", separator: !0, regex: pr.separator, populate: function (e, t) {
            ...
            name: "directedEdge", separator: !0, regex: pr.directedEdge, populate: function (e, t) {
                if (null == e.currentSubject) {
                    var n = {checks: []}, r = t, i = {checks: []};
                    return n.checks.push({type: Sr, source: r, target: i}), Fr(e, 0, n), e.edgeCount++, i
                }
                var a = {checks: []}, o = t, s = {checks: []};
                return a.checks.push({type: Dr, source: o, target: s}), Fr(e, 0, a), e.edgeCount++, s
            }
        }, {
            name: "undirectedEdge", separator: !0, regex: pr.undirectedEdge, populate: function (e, t) {
                if (null == e.currentSubject) {
                    var n = {checks: []}, r = t, i = {checks: []};
                    return n.checks.push({type: Cr, nodes: [r, i]}), Fr(e, 0, n), e.edgeCount++, i
                }
                var a = {checks: []}, o = t, s = {checks: []};
                return a.checks.push({type: Tr, node: o, neighbor: s}), Fr(e, 0, a), s
            }
        }, {
            name: "child", separator: !0, regex: pr.child, populate: function (e, t) {
                if (null == e.currentSubject) {
                    var n = {checks: []}, r = {checks: []}, i = e[e.length - 1];
                    return n.checks.push({type: Mr, parent: i, child: r}), Fr(e, 0, n), e.compoundCount++, r
                }
                if (e.currentSubject === t) {
                    ...
                    return a.checks.push({
                        ...
                        right: s,
                        subject: l
                    }), l.checks = t.checks, t.checks = [{type: zr}], c.checks.push({type: zr}), s.checks.push({
                        type: _r,
                        parent: c,
                        child: u
                    }), Fr(e, 0, a), e.currentSubject = l, e.compoundCount++, u
                }
                var h = {checks: []}, d = {checks: []}, p = [{type: _r, parent: h, child: d}];
                return h.checks = t.checks, t.checks = p, e.compoundCount++, d
            }
        }, {
            name: "descendant", separator: !0, regex: pr.descendant, populate: function (e, t) {
                if (null == e.currentSubject) {
                    var n = {checks: []}, r = {checks: []}, i = e[e.length - 1];
                    return n.checks.push({type: Br, ancestor: i, descendant: r}), Fr(e, 0, n), e.compoundCount++, r
                }
                if (e.currentSubject === t) {
                    var a = {checks: []}, o = e[e.length - 1], s = {checks: []}, l = {checks: []}, u = {checks: []},
                        c = {checks: []};
                ...
                var h = {checks: []}, d = {checks: []}, p = [{type: Nr, ancestor: h, descendant: d}];
                return h.checks = t.checks, t.checks = p, e.compoundCount++, d
            }
        }, {
            name: "subject", modifier: !0, regex: pr.subject, populate: function (e, t) {
                ...
                r === Sr ? n.type = Pr : r === Cr && (n.type = Tr, n.node = n.nodes[1], n.neighbor = n.nodes[0], n.nodes = null)
            }
        }];
    ...
    var qr = function (e) {
        for (var t, n, r, i = 0; i < Vr.length; i++) {
            var a = Vr[i], o = a.name, s = e.match(a.regexObj);
            if (null != s) {
                n = s, t = a, r = o;
                var l = s[0];
        ...
        var r, i, a, o = d(e), s = v(e), l = d(n), u = !1, c = !1, h = !1;
    ...
    Wr[fr] = function (e, t) {
        ...
        var n = e.field;
        e.operator;
        return void 0 !== Xr(t, n)
    }, Wr[Cr] = function (e, t) {
        var n = e.nodes[0], r = e.nodes[1], i = t.source(), a = t.target();
        return Hr(n, i) && Hr(r, a) || Hr(r, i) && Hr(n, a)
    }, Wr[Tr] = function (e, t) {
        return Hr(e.node, t) && t.neighborhood().some(function (t) {
            return t.isNode() && Hr(e.neighbor, t)
        })
    }, Wr[Sr] = function (e, t) {
        return Hr(e.source, t.source()) && Hr(e.target, t.target())
    }, Wr[Dr] = function (e, t) {
        return Hr(e.source, t) && t.outgoers().some(function (t) {
            return t.isNode() && Hr(e.target, t)
        })
    }, Wr[Pr] = function (e, t) {
        return Hr(e.target, t) && t.incomers().some(function (t) {
            return t.isNode() && Hr(e.source, t)
        })
    }, Wr[Mr] = function (e, t) {
        return Hr(e.child, t) && Hr(e.parent, t.parent())
    }, Wr[_r] = function (e, t) {
        return Hr(e.parent, t) && t.children().some(function (t) {
            return Hr(e.child, t)
        })
    }, Wr[Br] = function (e, t) {
        return Hr(e.descendant, t) && t.ancestors().some(function (t) {
            return Hr(e.ancestor, t)
        })
    }, Wr[Nr] = function (e, t) {
        return Hr(e.ancestor, t) && t.descendants().some(function (t) {
            return Hr(e.descendant, t)
        })
    }, Wr[Ir] = function (e, t) {
        return Hr(e.subject, t) && Hr(e.left, t) && Hr(e.right, t)
    }, Wr[zr] = function () {
        return !0
    }, Wr[gr] = function (e, t) {
    ...
    var Kr = function (e) {
        ...
        }) : d(e) ? this.parse(e) || (this.invalid = !0) : Ee("A selector must be created from a string; found ", e))
    }, Gr = Kr.prototype;
    [jr, {
        matches: function (e) {
            ...
            var t = this;
            if (1 === t.length && 1 === t[0].checks.length && t[0].checks[0].type === Er) return e.getElementById(t[0].checks[0].value).collection();
            var n = function (e) {
                for (var n = 0; n < t.length; n++) {
                    var r = t[n];
                    if (Hr(r, e)) return !0
    ...
    Zr.allAreNeighbours = Zr.allAreNeighbors, Zr.has = Zr.contains, Zr.equal = Zr.equals = Zr.same;
    var Ur, $r, Qr = function (e, t) {
        ...
        parent: function (e) {
            ...
            }(this.children()), this.spawn(t, {unique: !0}).filter(e)
        }
    };
    ...
    Jr.forEachDown = function (e) {
        return ei(this, e, !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1], ti)
    }, Jr.forEachUp = function (e) {
        return ei(this, e, !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1], ni)
    }, Jr.forEachUpAndDown = function (e) {
        return ei(this, e, !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1], ri)
    }, Jr.ancestors = Jr.parents, (Ur = $r = {
        data: cr.data({
            field: "data",
            bindingEvent: "data",
            allowBinding: !0,
        ...
        removeRscratch: cr.removeData({field: "rscratch", triggerEvent: !1}),
        id: function () {
            var e = this[0];
            if (e) return e._private.data.id
        }
    }).attr = Ur.data, Ur.removeAttr = Ur.removeData;
    var ii, ai, oi = $r, si = {};
    ...
    I(si, {
        degree: li(function (e, t) {
            return t.source().same(t.target()) ? 2 : 1
        }), indegree: li(function (e, t) {
            return t.target().same(e) ? 1 : 0
        }), outdegree: li(function (e, t) {
            return t.source().same(e) ? 1 : 0
        })
    }), I(si, {
        minDegree: ui("degree", function (e, t) {
            return e < t
        }), maxDegree: ui("degree", function (e, t) {
            return e > t
        }), minIndegree: ui("indegree", function (e, t) {
            return e < t
        }), maxIndegree: ui("indegree", function (e, t) {
            return e > t
        }), minOutdegree: ui("outdegree", function (e, t) {
            return e < t
        }), maxOutdegree: ui("outdegree", function (e, t) {
            return e > t
        })
    }), I(si, {
    ...
    (ii = ai = {
        ...
        positions: function (e, t) {
            if (g(e)) t ? this.silentPosition(e) : this.position(e); else if (p(e)) {
                var n = e, r = this.cy();
                r.startBatch();
        ...
        shift: function (e, t, n) {
            var r;
            if (g(e) ? (r = {x: v(e.x) ? e.x : 0, y: v(e.y) ? e.y : 0}, n = t) : d(e) && v(t) && ((r = {
                x: 0,
                y: 0
            })[e] = t), null != r) {
                var i = this.cy();
        ...
        renderedPosition: function (e, t) {
            var n = this[0], r = this.cy(), i = r.zoom(), a = r.pan(), o = g(e) ? e : void 0,
        ...
        relativePosition: function (e, t) {
            var n = this[0], r = this.cy(), i = g(e) ? e : void 0, a = void 0 !== i || void 0 !== t && d(e),
            ...
            if (n && n.isNode()) {
                if (!a) {
                    ...
                    return i = {x: s.x - h.x, y: s.y - h.y}, void 0 === e ? i : i[e]
                }
                for (var p = 0; p < this.length; p++) {
                    var f = this[p], v = o ? f.parent() : null, y = v && v.length > 0, m = y;
                    y && (v = v[0]);
                    var b = m ? v.position() : {x: 0, y: 0};
                    void 0 !== t ? f.position(e, t + b[e]) : void 0 !== i && f.position({x: i.x + b.x, y: i.y + b.y})
                }
            } else if (!a) return;
            return this
        }
    }).modelPosition = ii.point = ii.position, ii.modelPositions = ii.points = ii.positions, ii.renderedPoint = ii.renderedPosition, ii.relativePoint = ii.relativePosition;
    var di, pi, fi = ai;
    di = pi = {}, pi.renderedBoundingBox = function (e) {
    ...
    }, pi.dirtyCompoundBoundsCache = function () {
        var e = this.cy();
    ...
    }, pi.updateCompoundBounds = function () {
        ...
        function n(e) {
            if (e.isParent()) {
                var t = e._private, n = e.children(), r = "include" === e.pstyle("compound-sizing-wrt-labels").value,
                    ...
                    }).boundingBox({includeLabels: r, includeOverlays: !1, useCache: !1}), o = t.position;
                0 !== a.w && 0 !== a.h || ((a = {
                ...
                var h = y(i.width.val - a.w, s, l), d = h.biasDiff, p = h.biasComplementDiff,
    ...
    var gi = function (e) {
            ...
            return null == t ? e : vi(e, t.x1, t.y1, t.x2, t.y2)
        }, mi = function (e, t, n) {
            return Ne(e, t, n)
        }, bi = function (e, t, n) {
            if (!t.cy().headless()) {
                ...
                if ("none" !== t.pstyle(n + "-arrow-shape").value) {
                    ...
                    u.x1 = r - s, u.y1 = i - s, u.x2 = r + s, u.y2 = i + s, u.w = u.x2 - u.x1, u.h = u.y2 - u.y1, Ct(u, 1), vi(e, u.x1, u.y1, u.x2, u.y2)
                }
            }
        }, xi = function (e, t, n) {
            if (!t.cy().headless()) {
                ...
                if (t.pstyle(r + "label").strValue) {
                    var o, s, l, u, c = t.pstyle("text-halign"), h = t.pstyle("text-valign"), d = mi(a, "labelWidth", n),
                        p = mi(a, "labelHeight", n), f = mi(a, "labelX", n), g = mi(a, "labelY", n),
                    ...
                    o += v - Math.max(x, w), s += v + Math.max(x, w), l += y - Math.max(x, w), u += y + Math.max(x, w);
                    var P = n || "main", T = i.labelBounds, M = T[P] = T[P] || {};
                    M.x1 = o, M.y1 = l, M.x2 = s, M.y2 = u, M.w = s - o, M.h = u - l, Ct(M, 1);
                    var B = m && "autorotate" === b.strValue, _ = null != b.pfValue && 0 !== b.pfValue;
                    if (B || _) {
                        var N = B ? mi(i.rstyle, "labelAngle", n) : b.pfValue, I = Math.cos(N), z = Math.sin(N),
                            L = (o + s) / 2, A = (l + u) / 2;
                        if (!m) {
                            switch (c.value) {
                                case"left":
                        ...
                        }, R = O(o, l), F = O(o, u), V = O(s, l), q = O(s, u);
                        o = Math.min(R.x, F.x, V.x, q.x), s = Math.max(R.x, F.x, V.x, q.x), l = Math.min(R.y, F.y, V.y, q.y), u = Math.max(R.y, F.y, V.y, q.y)
                    }
                    vi(e, o, l, s, u), vi(i.labelBounds.all, o, l, s, u)
                }
                return e
            }
        }, wi = function (e) {
            ...
            var n, r = e._private, i = (null == t ? Si : wi(t)) === Si, a = Ei(e), o = r.bbCachePosKey === a,
                s = !(t.useCache && o) || null == r.bbCache;
            if (s ? (o || e.recalculateRenderedStyle(), n = function (e, t) {
                var n, r, i, a, o, s, l = e._private.cy, u = l.styleEnabled(), c = l.headless(), h = bt(), d = e._private,
                    p = u ? e.pstyle("display").value : "element", f = e.isNode(), g = e.isEdge(), v = "none" !== p,
                    y = d.rstyle, m = f && u ? e.pstyle("bounds-expansion").pfValue : 0;
                if (v) {
                    var b = 0;
                    u && t.includeOverlays && 0 !== e.pstyle("overlay-opacity").value && (b = e.pstyle("overlay-padding").value);
                    var x = 0;
                    if (u && (x = e.pstyle("width").pfValue / 2), f && t.includeNodes) {
                        var w = e.position();
                        o = w.x, s = w.y;
                        var E = e.outerWidth() / 2, k = e.outerHeight() / 2;
                        vi(h, n = o - E, i = s - k, r = o + E, a = s + k)
                    } else if (g && t.includeEdges) if (u && !c && (n = Math.min(y.srcX, y.midX, y.tgtX), r = Math.max(y.srcX, y.midX, y.tgtX), i = Math.min(y.srcY, y.midY, y.tgtY), a = Math.max(y.srcY, y.midY, y.tgtY), vi(h, n -= x, i -= x, r += x, a += x)), u && !c && "haystack" === e.pstyle("curve-style").strValue) {
                        var C = y.haystackPts || [];
                        if (n = C[0].x, i = C[0].y, n > (r = C[1].x)) {
                            var S = n;
                            n = r, r = S
                        }
                        if (i > (a = C[1].y)) {
                        ...
                        vi(h, n - x, i - x, r + x, a + x)
                    } else {
                        for (var P = y.bezierPts || y.linePts || [], T = 0; T < P.length; T++) {
                            var M = P[T];
                            n = M.x - x, r = M.x + x, i = M.y - x, a = M.y + x, vi(h, n, i, r, a)
                        }
                        if (0 === P.length) {
                            var B = e.source().position(), _ = e.target().position();
                            if ((n = B.x) > (r = _.x)) {
                                var N = n;
                                n = r, r = N
                            }
                    ...
                    if (u && t.includeEdges && g && (bi(h, e, "mid-source"), bi(h, e, "mid-target"), bi(h, e, "source"), bi(h, e, "target")), u && "yes" === e.pstyle("ghost").value) {
                        var z = e.pstyle("ghost-offset-x").pfValue, L = e.pstyle("ghost-offset-y").pfValue;
                        vi(h, h.x1 + z, h.y1 + L, h.x2 + z, h.y2 + L)
                    }
                    var A = d.bodyBounds = d.bodyBounds || {};
                    St(A, h), Ct(A, m), Ct(A, 1), u && (n = h.x1, r = h.x2, i = h.y1, a = h.y2, vi(h, n - b, i - b, r + b, a + b));
                    var O = d.overlayBounds = d.overlayBounds || {};
                    St(O, h), Ct(O, m), Ct(O, 1);
                    var R = d.labelBounds = d.labelBounds || {};
                    null != R.all ? wt(R.all) : R.all = bt(), u && t.includeLabels && (xi(h, e, null), g && (xi(h, e, "source"), xi(h, e, "target")))
                }
                return h.x1 = gi(h.x1), h.y1 = gi(h.y1), h.x2 = gi(h.x2), h.y2 = gi(h.y2), h.w = gi(h.x2 - h.x1), h.h = gi(h.y2 - h.y1), h.w > 0 && h.h > 0 && v && (Ct(h, m), Ct(h, 1)), h
                ...
                var l = Dt, u = r.bbCacheShift, c = function (e, t) {
                    null != e && l(e, t)
                };
                l(n, u);
                var h = r.bodyBounds, d = r.overlayBounds, p = r.labelBounds, f = r.arrowBounds;
            ...
            if (r.bbCacheShift.x = r.bbCacheShift.y = 0, !i) {
                var g = e.isNode();
                n = bt(), (t.includeNodes && g || t.includeEdges && !g) && (t.includeOverlays ? yi(n, r.overlayBounds) : yi(n, r.bodyBounds)), t.includeLabels && yi(n, r.labelBounds.all), n.w = n.x2 - n.x1, n.h = n.y2 - n.y1
            }
            return n
        }, Ci = {includeNodes: !0, includeEdges: !0, includeLabels: !0, includeOverlays: !0, useCache: !0}, Si = wi(Ci),
        Di = Me(Ci);
    pi.boundingBox = function (e) {
        if (1 === this.length && null != this[0]._private.bbCache && (void 0 === e || void 0 === e.useCache || !0 === e.useCache)) return e = void 0 === e ? Ci : Di(e), ki(this[0], e);
        var t = bt(), n = Di(e = e || Ci);
        if (this.cy().styleEnabled()) for (var r = 0; r < this.length; r++) {
            var i = this[r], a = i._private, o = Ei(i), s = a.bbCachePosKey === o, l = n.useCache && s;
        ...
        return t.x1 = gi(t.x1), t.y1 = gi(t.y1), t.x2 = gi(t.x2), t.y2 = gi(t.y2), t.w = gi(t.x2 - t.x1), t.h = gi(t.y2 - t.y1), t
    }, pi.dirtyBoundingBoxCache = function () {
        for (var e = 0; e < this.length; e++) {
            var t = this[e]._private;
            t.bbCache = null, t.bbCacheShift.x = t.bbCacheShift.y = 0, t.bbCachePosKey = null
        }
        return this.emitAndNotify("bounds"), this
    }, pi.shiftCachedBoundingBox = function (e) {
        for (var t = 0; t < this.length; t++) {
            var n = this[t]._private;
            null != n.bbCache && (n.bbCacheShift.x += e.x, n.bbCacheShift.y += e.y)
        }
        return this.emitAndNotify("bounds"), this
    }, pi.boundingBoxAt = function (e) {
        var t = this.nodes(), n = this.cy(), r = n.hasCompoundNodes();
        ...
        var a = xt(this.boundingBox({useCache: !1}));
        return t.silentPositions(function (e) {
            return e._private.bbAtOldPos
        }), n.endBatch(), a
    }, di.boundingbox = di.bb = di.boundingBox, di.renderedBoundingbox = di.renderedBoundingBox;
    var Pi, Ti, Mi = pi;
    Pi = Ti = {};
    var Bi = function (e) {
    ...
    Bi({name: "width"}), Bi({name: "height"}), Ti.padding = function () {
    ...
    }, Ii = Object.keys(Ni).reduce(function (e, t) {
        var n = Ni[t], r = function (e) {
    ...
    }, {}), zi = I({}, fi, Mi, _i, Ii), Li = function (e, t) {
        this.recycle(e, t)
    };
    ...
    Li.prototype = {
        instanceString: function () {
            ...
            if (this.isImmediatePropagationStopped = this.isPropagationStopped = this.isDefaultPrevented = Ai, null != e && e.preventDefault ? (this.type = e.type, this.isDefaultPrevented = e.defaultPrevented ? Oi : Ai) : null != e && e.type ? t = e : this.type = e, null != t && (this.originalEvent = t.originalEvent, this.type = null != t.type ? t.type : this.type, this.cy = t.cy, this.target = t.target, this.position = t.position, this.renderedPosition = t.renderedPosition, this.namespace = t.namespace, this.layout = t.layout), null != this.cy && null != this.position && null == this.renderedPosition) {
            ...
            this.isImmediatePropagationStopped = Oi, this.stopPropagation()
    ...
    var ji = qi.prototype, Yi = function (e, t, n, r, i, a, o) {
        ...
        return e.addEventFields(e.context, t), new Li(t.type, t)
    }, Wi = function (e, t, n) {
        if ("event" !== h(n)) if (g(n)) t(e, Xi(e, n)); else for (var r = f(n) ? n : n.split(/\s+/), i = 0; i < r.length; i++) {
            var a = r[i];
            if (!k(a)) {
                var o = a.match(Ri);
                if (o) {
                    var s = o[1], l = o[2] ? o[2] : null;
                    t(e, Xi(e, {type: s, namespace: l, target: e.context}))
                }
            }
        } else t(e, n)
    };
    ji.on = ji.addListener = function (e, t, n, r, i) {
        return Yi(this, function (e, t, n, r, i, a, o) {
            p(a) && e.listeners.push({event: t, callback: a, type: n, namespace: r, qualifier: i, conf: o})
        }, e, t, n, r, i), this
    }, ji.one = function (e, t, n, r) {
        return this.on(e, t, n, r, {one: !0})
    }, ji.removeListener = ji.off = function (e, t, n, r) {
        var i = this;
        0 !== this.emitting && (this.listeners = this.listeners.slice());
        for (var a = this.listeners, o = function (o) {
            var s = a[o];
            Yi(i, function (e, t, n, r, i, l) {
                if (s.type === n && (!r || s.namespace === r) && (!i || e.qualifierCompare(s.qualifier, i)) && (!l || s.callback === l)) return a.splice(o, 1), !1
            }, e, t, n, r)
        }, s = a.length - 1; s >= 0; s--) o(s);
        return this
    }, ji.emit = ji.trigger = function (e, t, n) {
        var r = this.listeners, i = r.length;
        return this.emitting++, f(t) || (t = [t]), Wi(this, function (e, a) {
    ...
    var Hi = {
        ...
        return d(e) ? new Kr(e) : e
    }, Gi = {
        createEmitter: function () {
            for (var e = 0; e < this.length; e++) {
                var t = this[e], n = t._private;
                n.emitter || (n.emitter = new qi(Hi, t))
            }
            return this
        }, emitter: function () {
            return this._private.emitter
        }, on: function (e, t, n) {
            for (var r = Ki(t), i = 0; i < this.length; i++) {
    ...
    var Zi = {
        nodes: function (e) {
            ...
            if (d(e) || m(e)) return new Kr(e).filter(this);
            if (p(e)) {
            ...
            for (var n = [], r = e, i = this.length < e.length, a = i ? r._private.map : this._private.map, o = i ? this : r, s = 0; s < o.length; s++) {
                var l = o[s]._private.data.id, u = a.get(l);
                u && n.push(u.ele)
            }
            return this.spawn(n)
        }, xor: function (e) {
            ...
            var t = this._private.cy;
            d(e) && (e = t.$(e));
            var n = [], r = [], i = [], a = e, o = function (e, t, n) {
                for (var r = 0; r < e.length; r++) {
            ...
            for (var i = t.map, a = 0; a < e.length; a++) {
                ...
                if (!i.has(s)) {
                    ...
                    var u = i.get(s).index;
                    this[u] = o, i.set(s, {ele: o, index: u})
                }
            }
            return this
    ...
    Ui.u = Ui["|"] = Ui["+"] = Ui.union = Ui.or = Ui.add, Ui["\\"] = Ui["!"] = Ui["-"] = Ui.difference = Ui.relativeComplement = Ui.subtract = Ui.not, Ui.n = Ui["&"] = Ui["."] = Ui.and = Ui.intersection = Ui.intersect, Ui["^"] = Ui["(+)"] = Ui["(-)"] = Ui.symmetricDifference = Ui.symdiff = Ui.xor, Ui.fnFilter = Ui.filterFn = Ui.stdFilter = Ui.filter, Ui.complement = Ui.abscomp = Ui.absoluteComplement;
    var $i = function (e, t) {
        ...
        forEach: function (e, t) {
            if (p(e)) for (var n = this.length, r = 0; r < n; r++) {
                var i = this[r];
    ...
    Qi.each = Qi.forEach;
    var Ji = Me({nodeDimensionsIncludeLabels: !1}), ea = {
        layoutDimensions: function (e) {
            if ((e = Ji(e)).nodeDimensionsIncludeLabels) {
                var t = this.boundingBox();
                return {w: t.w, h: t.h}
            }
            return {w: this.outerWidth(), h: this.outerHeight()}
        }, layoutPositions: function (e, t, n) {
            var r = this.nodes(), i = this.cy(), a = t.eles, o = function (e) {
                return e.id()
            }, s = D(n, o);
            ...
            if (t.animate) {
                for (var h = 0; h < r.length; h++) {
                    ...
                    if (null == t.animateFilter || t.animateFilter(d, h)) {
                        var f = d.animation({position: p, duration: t.animationDuration, easing: t.animationEasing});
                        e.animations.push(f)
                    } else d.position(p)
                }
                if (t.fit) {
                ...
                e.animations.forEach(function (e) {
                    ...
                    type: "layoutready",
                    layout: e
                }), sr.all(e.animations.map(function (e) {
                    return e.promise()
                })).then(function () {
    ...
    function ra(e, t) {
        ...
        return function () {
            var t = this[0];
            if (t) return ta(e, n, t)
        }
    }

    ea.createLayout = ea.makeLayout = ea.layout;
    var ia = {
        recalculateRenderedStyle: function (e) {
            ...
            var n = t.hasCompoundNodes(), r = t.style(), i = this;
    ...
    function oa(e) {
        ...
        return function () {
            ...
            if (i) {
                var o = i._private;
                if (!t(i)) return !1;
                if (i.isNode()) return !a || aa(i, r);
                var s = o.source, l = o.target;
                return n(s) && (!a || aa(s, n)) && (s === l || n(l) && (!a || aa(l, n)))
            }
        }
    }

    var sa = na("eleTakesUpSpace", function (e) {
        return "element" === e.pstyle("display").value && 0 !== e.width() && (!e.isNode() || 0 !== e.height())
    });
    ia.takesUpSpace = ra("takesUpSpace", oa({ok: sa}));
    var la = na("eleInteractive", function (e) {
        return "yes" === e.pstyle("events").value && "visible" === e.pstyle("visibility").value && sa(e)
    }), ua = na("parentInteractive", function (e) {
        return "visible" === e.pstyle("visibility").value && sa(e)
    });
    ia.interactive = ra("interactive", oa({ok: la, parentOk: ua, edgeOkViaNode: sa})), ia.noninteractive = function () {
        var e = this[0];
        if (e) return !e.interactive()
    };
    var ca = na("eleVisible", function (e) {
        return "visible" === e.pstyle("visibility").value && 0 !== e.pstyle("opacity").pfValue && sa(e)
    }), ha = sa;
    ia.visible = ra("visible", oa({ok: ca, edgeOkViaNode: ha})), ia.hidden = function () {
        var e = this[0];
        if (e) return !e.visible()
    }, ia.isBundledBezier = ra("isBundledBezier", function () {
        return !!this.cy().styleEnabled() && (!this.removed() && "bezier" === this.pstyle("curve-style").value && this.takesUpSpace())
    }), ia.bypass = ia.css = ia.style, ia.renderedCss = ia.renderedStyle, ia.removeBypass = ia.removeCss = ia.removeStyle, ia.pstyle = ia.parsedStyle;
    var da = {};
    ...
    }), da.deselect = da.unselect, da.grabbed = function () {
        var e = this[0];
        if (e) return e._private.grabbed
    }, fa({field: "active", on: "activate", off: "unactivate"}), da.inactive = function () {
        var e = this[0];
    ...
    function wa(e) {
        return e = I({}, {codirected: !1}, e), function (t) {
            for (var n = [], r = this.edges(), i = e, a = 0; a < r.length; a++) for (var o = r[a]._private, s = o.source, l = s._private.data.id, u = o.data.target, c = s._private.edges, h = 0; h < c.length; h++) {
                var d = c[h], p = d._private.data, f = p.target, g = p.source, v = f === u && g === l,
                    y = l === f && u === g;
    ...
    ga.clearTraversalCache = function () {
        for (var e = 0; e < this.length; e++) this[e]._private.traversalCache = null
    }, I(ga, {
        roots: va({noIncomingEdges: !0}),
        leaves: va({noOutgoingEdges: !0}),
        outgoers: Qr(ya({outgoing: !0}), "outgoers"),
        successors: ma({outgoing: !0}),
        incomers: Qr(ya({incoming: !0}), "incomers"),
        predecessors: ma({incoming: !0})
    }), I(ga, {
        neighborhood: Qr(function (e) {
    ...
    }), ga.neighbourhood = ga.neighborhood, ga.closedNeighbourhood = ga.closedNeighborhood, ga.openNeighbourhood = ga.openNeighborhood, I(ga, {
        source: Qr(function (e) {
            var t, n = this[0];
            return n && (t = n._private.source || n.cy().collection()), t && e ? t.filter(e) : t
        }, "source"), target: Qr(function (e) {
            var t, n = this[0];
            return n && (t = n._private.target || n.cy().collection()), t && e ? t.filter(e) : t
        }, "target"), sources: ba({attr: "source"}), targets: ba({attr: "target"})
    }), I(ga, {
        edgesWith: Qr(xa(), "edgesWith"),
        edgesTo: Qr(xa({thisIsSrc: !0}), "edgesTo")
    }), I(ga, {
        connectedEdges: Qr(function (e) {
            for (var t = [], n = 0; n < this.length; n++) {
                var r = this[n];
        ...
        parallelEdges: Qr(wa(), "parallelEdges"),
        codirectedEdges: Qr(wa({codirected: !0}), "codirectedEdges")
    }), I(ga, {
    ...
    var Ea = function (e, t, n) {
        ...
        if (void 0 !== e && w(e)) {
            ...
            if (t) {
                if (t.length > 0 && g(t[0]) && !b(t[0])) {
                    ...
                    for (var a = [], o = new Ae, s = 0, l = t.length; s < l; s++) {
                        ...
                        null == u.data && (u.data = {});
                        var c = u.data;
                        if (null == c.id) c.id = Ea(e, u); else if (e.hasElementWithId(c.id) || o.has(c.id)) continue;
                        var h = new Oe(e, u, !1);
                        a.push(h), o.add(c.id)
                    }
                    t = a
            ...
            this._private = {cy: e, map: r}, i && this.restore()
        } else Ee("A collection must have a reference to the core")
    }, Ca = Oe.prototype = ka.prototype;
    Ca.instanceString = function () {
        return "collection"
    }, Ca.spawn = function (e, t, n) {
        return w(e) || (n = t, t = e, e = this.cy()), new ka(e, t, n)
    }, Ca.spawnSelf = function () {
        return this.spawn(this)
    }, Ca.cy = function () {
        return this._private.cy
    }, Ca.renderer = function () {
        return this._private.cy.renderer()
    }, Ca.element = function () {
        return this[0]
    }, Ca.collection = function () {
        return x(this) ? this : new ka(this._private.cy, [this])
    }, Ca.unique = function () {
        return new ka(this._private.cy, this, {unique: !0})
    }, Ca.hasElementWithId = function (e) {
        return this._private.map.has(e)
    }, Ca.getElementById = function (e) {
        var t = this._private.cy, n = this._private.map.get(e);
        return n ? n.ele : new ka(t)
    }, Ca.$id = Ca.getElementById, Ca.poolIndex = function () {
        var e = this._private.cy._private.elements, t = this[0]._private.data.id;
        return e._private.map.get(t).index
    }, Ca.indexOf = function (e) {
        var t = e[0]._private.data.id;
        return this._private.map.get(t).index
    }, Ca.indexOfId = function (e) {
            ...
            if (g(e)) {
                if (n.startBatch(), e.data) {
                    ...
                    if (t.isEdge()) {
                        ...
                        var u = e.data.parent;
                        null == u && null == i.parent || u === i.parent || (void 0 === u && (u = null), t = t.move({parent: u}))
                    }
                }
                ...
                return c("removed", "remove", "restore"), c("selected", "select", "unselect"), c("selectable", "selectify", "unselectify"), c("locked", "lock", "unlock"), c("grabbable", "grabify", "ungrabify"), null != e.classes && t.classes(e.classes), n.endBatch(), this
            }
            if (void 0 === e) {
                var h = {
                    data: Se(r.data),
        ...
        return new ka(e, t)
    }, Ca.copy = Ca.clone, Ca.restore = function () {
        ...
        for (t = 0; t < e.length; t++) {
            var p = e[t], f = p._private, g = f.data;
            if (p.clearTraversalCache(), r || f.removed) if (void 0 === g.id) g.id = Ea(i, p); else if (v(g.id)) g.id = "" + g.id; else {
                if (k(g.id) || !d(g.id)) {
            ...
            if (p.isEdge()) {
                ...
                var P = i.getElementById(g.source), T = i.getElementById(g.target);
                P._private.edges.push(b), T._private.edges.push(b), b._private.source = P, b._private.target = T
            }
            f.map = new ze, f.map.set(y, {ele: p, index: 0}), f.removed = !1, r && i.addToPool(p)
        }
        for (var M = 0; M < o.length; M++) {
            var B = o[M], _ = B._private.data;
            v(_.parent) && (_.parent = "" + _.parent);
            var N = _.parent;
            if (null != N) {
                var I = i.getElementById(N);
                if (I.empty()) _.parent = void 0; else {
        ...
        if (e.length > 0) {
            for (var A = new ka(i, e), O = 0; O < A.length; O++) {
                var R = A[O];
        ...
        var e = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0],
            t = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1], n = [], r = {},
            i = this._private.cy;
        ...
        var t = this._private.cy, n = this;
        if (void 0 !== e.source || void 0 !== e.target) {
            var r = e.source, i = e.target, a = null != r && t.hasElementWithId(r),
                o = null != i && t.hasElementWithId(i);
            (a || o) && (t.batch(function () {
                n.remove(!1, !1), n.emitAndNotify("moveout");
                for (var e = 0; e < n.length; e++) {
                    var t = n[e], s = t._private.data;
                    t.isEdge() && (a && (s.source = r), o && (s.target = i))
                }
                n.restore(!1, !1)
            }), n.emitAndNotify("move"))
        } else if (void 0 !== e.parent) {
            var s = e.parent;
            if (null === s || t.hasElementWithId(s)) {
    ...
    }, Qi, ea, ia, da, ga].forEach(function (e) {
        I(Ca, e)
    });
    var Sa = {
        add: function (e) {
            ...
            if (m(e)) {
                ...
                for (var s = e, l = [], u = ["nodes", "edges"], c = 0, h = u.length; c < h; c++) {
                    var d = u[c], p = s[d];
                    if (f(p)) for (var v = 0, y = p.length; v < y; v++) {
                        var b = I({group: d}, p[v]);
                        l.push(b)
                    }
                }
    ...
    function Da(e, t, n, r) {
        ...
        function m(t) {
            ...
            var p = r + (t - d[--c]) / (d[c + 1] - d[c]) * u, f = y(p, e, n);
    ...
    var Pa = function () {
        ...
        ease: Ta(.25, .1, .25, 1),
        "ease-in": Ta(.42, 0, 1, 1),
        "ease-out": Ta(0, 0, .58, 1),
        "ease-in-out": Ta(.42, 0, .58, 1),
        "ease-in-sine": Ta(.47, 0, .745, .715),
        "ease-out-sine": Ta(.39, .575, .565, 1),
        "ease-in-out-sine": Ta(.445, .05, .55, .95),
        "ease-in-quad": Ta(.55, .085, .68, .53),
        "ease-out-quad": Ta(.25, .46, .45, .94),
        "ease-in-out-quad": Ta(.455, .03, .515, .955),
        "ease-in-cubic": Ta(.55, .055, .675, .19),
        "ease-out-cubic": Ta(.215, .61, .355, 1),
        "ease-in-out-cubic": Ta(.645, .045, .355, 1),
        "ease-in-quart": Ta(.895, .03, .685, .22),
        "ease-out-quart": Ta(.165, .84, .44, 1),
        "ease-in-out-quart": Ta(.77, 0, .175, 1),
        "ease-in-quint": Ta(.755, .05, .855, .06),
        "ease-out-quint": Ta(.23, 1, .32, 1),
        "ease-in-out-quint": Ta(.86, 0, .07, 1),
        "ease-in-expo": Ta(.95, .05, .795, .035),
        "ease-out-expo": Ta(.19, 1, .22, 1),
        "ease-in-out-expo": Ta(1, 0, 0, 1),
        "ease-in-circ": Ta(.6, .04, .98, .335),
        "ease-out-circ": Ta(.075, .82, .165, 1),
        "ease-in-out-circ": Ta(.785, .135, .15, .86),
    ...
    function Na(e, t, n, r, i) {
        ...
        n < 0 ? n = 0 : n > 1 && (n = 1);
        var o = _a(e, i), s = _a(t, i);
        if (v(o) && v(s)) return Ba(a, o, s, n, r);
        if (f(o) && f(s)) {
    ...
    function Ia(e, t, n, r) {
        ...
        if (!o.easingImpl) if (null == s) o.easingImpl = Ma.linear; else {
            var c, h, p;
            if (d(s)) c = u.parse("transition-timing-function", s).value; else c = s;
            d(c) ? (h = c, p = []) : (h = c[1], p = c.slice(2).map(function (e) {
                return +e
            })), p.length > 0 ? ("spring" === h && p.push(o.duration), o.easingImpl = Ma[h].apply(null, p)) : o.easingImpl = Ma[h]
        }
        ...
        if (f = 0 === o.duration ? 1 : (n - l) / o.duration, o.applying && (f = o.progress), f < 0 ? f = 0 : f > 1 && (f = 1), null == o.delay) {
            ...
            if (y && i && !e.locked()) {
                var m = {};
                za(v.x, y.x) && (m.x = Na(v.x, y.x, f, g)), za(v.y, y.y) && (m.y = Na(v.y, y.y, f, g)), e.position(m)
            }
            var b = o.startPan, x = o.pan, w = a.pan, E = null != x && r;
            E && (za(b.x, x.x) && (w.x = Na(b.x, x.x, f, g)), za(b.y, x.y) && (w.y = Na(b.y, x.y, f, g)), e.emit("pan"));
            var k = o.startZoom, C = o.zoom, S = null != C && r;
            S && (za(k, C) && (a.zoom = Na(k, C, f, g)), e.emit("zoom")), (E || S) && e.emit("viewport");
            var D = o.style;
            if (D && D.length > 0 && i) {
                for (var P = 0; P < D.length; P++) {
                    var T = D[P], M = T.name, B = T, _ = o.startStyle[M], N = Na(_, B, f, g, u.properties[_.name]);
    ...
    function Aa(e, t) {
        ...
        function i(t, n) {
            ...
            for (var c = function (e) {
                ...
                var d = a[h], p = d._private;
                p.stopped ? (a.splice(h, 1), p.hooked = !1, p.playing = !1, p.started = !1, c(p.frames)) : (p.playing || p.applying) && (p.playing && p.applying && (p.applying = !1), p.started || La(0, d, e), Ia(t, d, e, n), p.applying && (p.applying = !1), c(p.frames), null != p.step && p.step(e), d.completed() && (a.splice(h, 1), p.hooked = !1, p.playing = !1, p.started = !1, c(p.completes)), s = !0)
            }
    ...
    var Oa = {
        ...
        createEmitter: function () {
            var e = this._private;
            return e.emitter || (e.emitter = new qi(Ra, this)), this
        }, emitter: function () {
            return this._private.emitter
        }, on: function (e, t, n) {
            return this.emitter().on(e, Fa(t), n), this
        }, removeListener: function (e, t, n) {
            return this.emitter().removeListener(e, Fa(t), n), this
        }, one: function (e, t, n) {
            return this.emitter().one(e, Fa(t), n), this
        }, once: function (e, t, n) {
            return this.emitter().one(e, Fa(t), n), this
        }, emit: function (e, t) {
    ...
    ja.createLayout = ja.makeLayout = ja.layout;
    var Ya = {
        notify: function (e, t) {
            var n = this._private;
            if (this.batching()) {
                ...
                var i = this.renderer();
                !this.isDestroyed() && i && i.notify(e, t)
            }
    ...
    var Ha = {
        collection: function (e, t) {
            return d(e) ? this.$(e) : m(e) ? e.collection() : f(e) ? new ka(this, e, t) : new ka(this)
        }, nodes: function (e) {
    ...
    Ka.apply = function (e) {
        ...
        return n[r] = a, a
    }, Ka.getContextMeta = function (e) {
        var t, n = "", r = e._private.styleCxtKey || "";
        ...
        return n[t] = r, r
    }, Ka.applyContextStyle = function (e, t, n) {
        for (var r = e.diffPropNames, i = {}, a = this.types, o = 0; o < r.length; o++) {
            ...
            if (u !== l) {
                if (l.mapped === a.fn && null != u.mapping && u.mapping.value === l.value) {
                    var c = u.mapping;
        ...
        return {diffProps: i}
    }, Ka.updateStyleHints = function (e) {
        ...
        for (var h = function (e, n) {
            ...
            var g = r[f], v = l[g];
            if (null != v) {
                var y = this.properties[g], m = y.type, b = y.groupKey, x = void 0;
                null != y.hashOverride ? x = y.hashOverride(e, v) : null != v.pfValue && (x = v.pfValue);
                var w = null == y.enums ? v.value : null, E = null != x, k = E || null != w, C = v.units;
                if (m.number && k) {
                    var S = E ? x : w;
                    if (m.multiple) for (var D = 0; D < S.length; D++) h(p(S[D]), b); else h(p(S), b);
                    E || null == C || d(C, b)
                } else d(v.strValue, b)
            }
        }
        for (var P = 0, T = 0; T < i.length; T++) {
            var M = i[T], B = t.styleKeys[M];
            P = ue(B, P)
        }
        t.styleKey = P;
        ...
        if (t.labelKey = a(e, ["label"], _), t.labelStyleKey = ue(t.styleKeys.commonLabel, t.labelKey), s || (t.sourceLabelKey = a(e, ["source-label"], _), t.sourceLabelStyleKey = ue(t.styleKeys.commonLabel, t.sourceLabelKey), t.targetLabelKey = a(e, ["target-label"], _), t.targetLabelStyleKey = ue(t.styleKeys.commonLabel, t.targetLabelKey)), s) {
            var N = t.styleKeys, I = N.nodeBody, z = N.nodeBorder, L = N.backgroundImage, A = N.compound, O = N.pie;
            t.nodeKey = ce([z, L, A, O], I), t.hasPie = 0 != O
        }
        return o !== t.styleKey
    }, Ka.clearStyleHints = function (e) {
        var t = e._private;
    ...
    }, Ka.applyParsedProperty = function (e, t) {
        var n, r = this, i = t, a = e._private.style, o = r.types, s = r.properties[i.name].type, l = i.bypass,
            u = a[i.name], c = u && u.bypass, h = e._private, d = function (e) {
    ...
    }, Ka.updateTransitions = function (e, t) {
        ...
        if (i.length > 0 && a > 0) {
            for (var s = {}, l = !1, u = 0; u < i.length; u++) {
                var c = i[u], h = e.pstyle(c), d = t[c];
                if (d) {
                    var p = d.prev, g = null != d.next ? d.next : h, y = !1, m = void 0;
            ...
            if (!l) return;
            r.transitioning = !0, new sr(function (t) {
    ...
    }, Ka.checkTrigger = function (e, t, n, r, i, a) {
        var o = this.properties[t], s = i(o);
        null != s && s(n, r) && a(o)
    }, Ka.checkZOrderTrigger = function (e, t, n, r) {
        var i = this;
    ...
    }, Ka.checkBoundsTrigger = function (e, t, n, r) {
        this.checkTrigger(e, t, n, r, function (e) {
    ...
    }, Ka.checkTriggers = function (e, t, n, r) {
    ...
    var Ga = {
        applyBypass: function (e, t, n, r) {
            ...
            for (var r = 0; r < e.length; r++) {
                for (var i = e[r], a = {}, o = 0; o < t.length; o++) {
                    ...
                    if (u && u.bypass) {
                        var c = this.parse(s, "", !0), h = a[l.name] = {prev: u};
        ...
        getRenderedStyle: function (e, t) {
            ...
            var r, i, a, o, s, l, u = n;
            for (s = 0; s < t.length; s++) if (r = t[s], null != (i = e.pstyle(r, !1))) if (null != i.pfValue) u = ue(o, u); else for (a = i.strValue, l = 0; l < a.length; l++) o = a.charCodeAt(l), u = ue(o, u);
            return u
        }
    };
    Ua.getPropertiesHash = Ua.getNonDefaultPropertiesHash;
    var $a = {
    ...
    !function () {
        ...
        Ja.types = {
            ...
            nodeShape: {enums: ["rectangle", "roundrectangle", "round-rectangle", "cutrectangle", "cut-rectangle", "bottomroundrectangle", "bottom-round-rectangle", "barrel", "ellipse", "triangle", "square", "pentagon", "hexagon", "concavehexagon", "concave-hexagon", "heptagon", "octagon", "tag", "star", "diamond", "vee", "rhomboid", "polygon"]},
        ...
        var i = {
            ...
            }, a = Ja.types, o = [{name: "label", type: a.text, triggersBounds: i.any}, {
                name: "text-rotation",
                type: a.textRotation,
            ...
            h = [{name: "events", type: a.bool}, {name: "text-events", type: a.bool}], p = [{
                name: "display",
                type: a.display,
            ...
            g = [{name: "transition-property", type: a.propList}, {
            ...
            }, y = [{name: "height", type: a.nodeSize, triggersBounds: i.any, hashOverride: v}, {
                name: "width",
                type: a.nodeSize,
                triggersBounds: i.any,
                hashOverride: v
            ...
            x = [{name: "position", type: a.position, triggersBounds: i.any}, {
            ...
            w = [{name: "line-style", type: a.lineStyle}, {name: "line-color", type: a.color}, {
                name: "line-fill",
                type: a.fill
            ...
            E = [{name: "ghost", type: a.bool, triggersBounds: i.any}, {
                name: "ghost-offset-x",
                type: a.bidirectionalSize,
                triggersBounds: i.any
                ...
                name: "ghost-opacity",
                type: a.zeroOneNumber
            }], k = [{name: "selection-box-color", type: a.color}, {
                ...
                type: a.color
            }, {name: "outside-texture-bg-opacity", type: a.zeroOneNumber}], C = [];
        Ja.pieBackgroundN = 16, C.push({name: "pie-size", type: a.sizeMaybePercent});
        for (var S = 1; S <= Ja.pieBackgroundN; S++) C.push({
            name: "pie-" + S + "-background-color",
            type: a.color
        }), C.push({
            name: "pie-" + S + "-background-size",
            type: a.percent
        }), C.push({name: "pie-" + S + "-background-opacity", type: a.zeroOneNumber});
        var D = [], P = Ja.arrowPrefixes = ["source", "mid-source", "target", "mid-target"];
        ...
        var T = Ja.properties = [].concat(h, g, p, f, E, c, u, o, s, l, y, m, b, C, x, w, D, k),
            M = Ja.propertyGroups = {
                behavior: h,
                transition: g,
                visibility: p,
                ...
                edgeArrow: D,
                core: k
            }, B = Ja.propertyGroupNames = {};
        (Ja.propertyGroupKeys = Object.keys(M)).forEach(function (e) {
        ...
        var N = Ja.aliases = [{name: "content", pointsTo: "label"}, {
        ...
        Ja.propertyNames = T.map(function (e) {
            return e.name
        });
        ...
        for (var L = 0; L < N.length; L++) {
            var A = N[L], O = T[A.pointsTo], R = {name: A.name, alias: !0, pointsTo: O};
            T.push(R), T[A.name] = R
        }
    ...
    eo.parseImpl = function (e, t, n, r) {
        ...
        if (p(t)) return {name: e, value: t, strValue: "fn", mapped: o.fn, bypass: n};
        if (!s || r || t.length < 7 || "a" !== t[1]) ; else {
            if (t.length >= 7 && "d" === t[0] && (l = new RegExp(o.data.regex).exec(t))) {
                if (n) return !1;
                var h = o.data;
                return {name: e, value: l, strValue: "" + t, mapped: h, field: l[1], bypass: n}
            }
        ...
        if (c.number) {
            ...
            if (c.integer && (!v(B = t) || Math.floor(B) !== B)) return null;
            if (void 0 !== c.min && (t < c.min || c.strictMin && t === c.min) || void 0 !== c.max && (t > c.max || c.strictMax && t === c.max)) return null;
            var R = {name: e, value: t, strValue: "" + t + (I || ""), units: I, bypass: n};
            return c.unitless || "px" !== I && "em" !== I ? R.pfValue = t : R.pfValue = "px" !== I && I ? this.getEmSizeInPixels() * t : t, "ms" !== I && "s" !== I || (R.pfValue = "ms" === I ? t : 1e3 * t), "deg" !== I && "rad" !== I || (R.pfValue = "rad" === I ? t : lt(t)), "%" === I && (R.pfValue = t / 100), R
        }
        if (c.propList) {
            var F = [], V = "" + t;
            if ("none" === V) ; else {
                for (var q = V.split(/\s*,\s*|\s+/), j = 0; j < q.length; j++) {
                    var Y = q[j].trim();
                    this.properties[Y] ? F.push(Y) : Ce("`" + Y + "` is not a valid property name")
                }
        ...
        if (c.regex || c.regexes) {
            ...
            for (var H = c.regexes ? c.regexes : [c.regex], K = 0; K < H.length; K++) {
                var G = new RegExp(H[K]).exec(t);
                if (G) return {name: e, value: c.singleRegexMatchValue ? G[1] : G, strValue: "" + t, bypass: n}
            }
            return null
        }
    ...
    }, to.fromJson = function (e, t) {
        var n = new to(e);
        return n.fromJson(t), n
    }, to.fromString = function (e, t) {
        return new to(e).fromString(t)
    }, [Ka, Ga, Za, Ua, $a, Qa, Ja, eo].forEach(function (e) {
        I(no, e)
    }), to.types = no.types, to.properties = no.properties, to.propertyGroups = no.propertyGroups, to.propertyGroupNames = no.propertyGroupNames, to.propertyGroupKeys = no.propertyGroupKeys;
    var ro = {
        style: function (e) {
            ...
            var t = this._private;
            return E(e) ? t.style = e.generateStyle(this) : f(e) ? t.style = to.fromJson(this, e) : d(e) ? t.style = to.fromString(this, e) : t.style = to(this), t.style
        }
    }, io = {
        autolock: function (e) {
    ...
    io.centre = io.center, io.autolockNodes = io.autolock, io.autoungrabifyNodes = io.autoungrabify;
    var ao = function (e) {
        ...
        n && (n._cyreg = r), r.cy = t;
        var o = void 0 !== a && void 0 !== n && !e.headless, s = e;
        s.layout = I({name: o ? "grid" : "null"}, s.layout), s.renderer = I({name: o ? "canvas" : "null"}, s.renderer);
        var l = function (e, t, n) {
            ...
            pan: {x: g(s.pan) && v(s.pan.x) ? s.pan.x : 0, y: g(s.pan) && v(s.pan.y) ? s.pan.y : 0},
            animation: {current: [], queue: []},
            hasCompoundNodes: !1
        };
        ...
        t.initRenderer(c);
        !function (e, t) {
            if (e.some(C)) return sr.all(e).then(t);
            t(e)
    ...
    I(oo, {
        ...
        destroy: function () {
            var e = this;
            if (!e.isDestroyed()) return e.stopAnimationLoop(), e.destroyRenderer(), this.emit("destroy"), e._private.destroyed = !0, e
        },
        ...
        mount: function (e, t) {
            if (null != e) {
                var n = this, r = n._private, i = r.options, a = t || {name: "canvas"};
                return i.renderer = a, !y(e) && y(e[0]) && (e = e[0]), n.stopAnimationLoop(), n.destroyRenderer(), r.container = e, r.styleEnabled = !0, n.initRenderer(a), n.startAnimationLoop(), n.style(i.style), n.emit("mount"), n
            }
        },
        unmount: function () {
            var e = this;
        ...
        json: function (e) {
            ...
            if (g(e)) {
                if (t.startBatch(), e.elements) {
                    var i = {}, a = function (e, n) {
                        for (var r = [], a = [], o = 0; o < e.length; o++) {
                            var s = e[o], l = s.data.id, u = t.getElementById(l);
                        ...
                        for (var c = 0; c < a.length; c++) {
                            var h = a[c], d = h.ele, p = h.json;
                            d.json(p)
                        }
                    };
                    if (f(e.elements)) a(e.elements); else for (var o = ["nodes", "edges"], s = 0; s < o.length; s++) {
                ...
                e.style && t.style(e.style), null != e.zoom && e.zoom !== n.zoom && t.zoom(e.zoom), e.pan && (e.pan.x === n.pan.x && e.pan.y === n.pan.y || t.pan(e.pan));
        ...
        removeScratch: cr.removeData({field: "scratch", event: "scratch", triggerFnName: "trigger", triggerEvent: !0})
    }), oo.$id = oo.getElementById, [Sa, Oa, Va, qa, ja, Ya, Wa, Ha, ro, io].forEach(function (e) {
        I(oo, e)
    });
    var so = {
        fit: !0,
    ...
    co.prototype.run = function () {
        var e, t = this.options, n = t, r = t.cy, i = n.eles, a = i.nodes().filter(function (e) {
            ...
            u = bt(n.boundingBox ? n.boundingBox : {x1: 0, y1: 0, w: r.width(), h: r.height()});
        if (m(n.roots)) e = n.roots; else if (f(n.roots)) {
            for (var c = [], h = 0; h < n.roots.length; h++) {
                var p = n.roots[h], g = r.getElementById(p);
                c.push(g)
            }
            e = r.collection(c)
        } else if (d(n.roots)) e = r.$(n.roots); else if (s) e = a.roots(); else {
            var v = i.components();
            e = r.collection();
        ...
        var x = [], w = {}, E = function (e, t) {
            null == x[t] && (x[t] = []);
            var n = x[t].length;
            x[t].push(e), uo(e, {index: n, depth: t})
        };
        o.bfs({
        ...
        var D = function (e) {
            for (var t = x[e], n = 0; n < t.length; n++) {
                var r = t[n];
                null != r ? uo(r, {depth: e, index: n}) : (t.splice(n, 1), n--)
            }
        }, P = function () {
            for (var e = 0; e < x.length; e++) D(e)
        }, T = function (e, t) {
            for (var n = lo(e), r = e.incomers().filter(function (e) {
            ...
            return n.depth <= a && (t[o] ? null : (function (e, t) {
                var n = lo(e), r = n.depth, i = n.index;
                x[r][i] = null, E(e, t)
            }(e, a + 1), t[o] = !0, !0))
        };
        if (s && l) {
        ...
        if (n.avoidOverlap) for (var A = 0; A < a.length; A++) {
            var O = a[A].layoutDimensions(n), R = O.w, F = O.h;
            L = Math.max(L, R, F)
        }
        for (var V = {}, q = function (e) {
            if (V[e.id()]) return V[e.id()];
            for (var t = lo(e).depth, n = e.neighborhood(), r = 0, i = 0, o = 0; o < n.length; o++) {
                var s = n[o];
                if (!s.isEdge() && !s.isParent() && a.has(s)) {
                    var l = lo(s), u = l.index, c = l.depth;
                    if (null != u && null != c) {
                        var h = x[c].length;
                        c < t && (r += u / (h - 1), i++)
                    }
        ...
        return a.layoutPositions(this, n, function (e) {
            var t = lo(e), r = t.depth, i = t.index, a = x[r].length, o = Math.max(u.w / ((n.grid ? U : a) + 1), L),
                s = Math.max(u.h / (x.length + 1), L), l = Math.min(u.w / 2 / x.length, u.h / 2 / x.length);
            if (l = Math.max(l, L), n.circle) {
                var c = l * r + l - (x.length > 0 && x[0].length <= 3 ? l / 2 : 0), h = 2 * Math.PI / x[r].length * i;
                return 0 === r && 1 === x[0].length && (c = 1), {x: G + c * Math.cos(h), y: Z + c * Math.sin(h)}
            }
    ...
    po.prototype.run = function () {
        ...
        for (var o, s = bt(t.boundingBox ? t.boundingBox : {
            x1: 0,
            y1: 0,
            w: n.width(),
            h: n.height()
            ...
            var p = a[d].layoutDimensions(t), f = p.w, g = p.h;
            h = Math.max(h, f, g)
        }
        if (o = v(t.radius) ? t.radius : a.length <= 1 ? 0 : Math.min(s.h, s.w) / 2 - h, a.length > 1 && t.avoidOverlap) {
            h *= 1.75;
            var y = Math.cos(c) - Math.cos(0), m = Math.sin(c) - Math.sin(0), b = Math.sqrt(h * h / (y * y + m * m));
            o = Math.max(b, o)
        }
    ...
    vo.prototype.run = function () {
        for (var e = this.options, t = e, n = void 0 !== t.counterclockwise ? !t.counterclockwise : t.clockwise, r = e.cy, i = t.eles.nodes().not(":parent"), a = bt(t.boundingBox ? t.boundingBox : {
            x1: 0,
            y1: 0,
            w: r.width(),
            h: r.height()
            ...
            var h, d = i[c];
            h = t.concentric(d), l.push({value: h, node: d}), d._private.scratch.concentric = h
        }
        i.updateStyle();
        ...
        for (var g = t.levelWidth(i), v = [[]], y = v[0], m = 0; m < l.length; m++) {
            var b = l[m];
        ...
        if (!t.avoidOverlap) {
            var w = v.length > 0 && v[0].length > 1, E = (Math.min(a.w, a.h) / 2 - x) / (v.length + w ? 1 : 0);
            x = Math.min(x, E)
        }
        for (var k = 0, C = 0; C < v.length; C++) {
            var S = v[C], D = void 0 === t.sweep ? 2 * Math.PI - 2 * Math.PI / S.length : t.sweep,
                P = S.dTheta = D / Math.max(1, S.length - 1);
            if (S.length > 1 && t.avoidOverlap) {
                var T = Math.cos(P) - Math.cos(0), M = Math.sin(P) - Math.sin(0),
        ...
        for (var O = {}, R = 0; R < v.length; R++) for (var F = v[R], V = F.dTheta, q = F.r, j = 0; j < F.length; j++) {
            var Y = F[j], X = t.startAngle + (n ? 1 : -1) * V * j, W = {x: o + q * Math.cos(X), y: s + q * Math.sin(X)};
            O[Y.node.id()] = W
        }
    ...
    function mo(e) {
        this.options = I({}, yo, e), this.options.layout = this
    }

    mo.prototype.run = function () {
        var e = this.options, t = e.cy, n = this, r = this.thread, i = e.weaver ? e.weaver.Thread : null, a = {
        ...
        r && !r.stopped() || (r = this.thread = i ? new i : a), n.stopped = !1, !0 !== e.animate && !1 !== e.animate || n.emit({
            type: "layoutstart",
            layout: n
        }), fo = !0 === e.debug;
        var o = bo(t, n, e);
        fo && (void 0)(o), e.randomize && Eo(o, t);
        var s = Date.now(), l = !1, u = function (n) {
            n = n || {}, l && !n.next || !n.force && Date.now() - s < e.animationThreshold || (l = !0, oe(function () {
                Co(o, t, e), !0 === e.fit && t.fit(e.padding), l = !1, n.next && n.next()
            }))
        };
        r.on("message", function (e) {
            ...
            var t, n, r = e.layoutInfo, i = e.options, o = function (e, t) {
                ...
                if (e.cmptId === t.cmptId || n.isCompound) {
                    ...
                    0 === i && 0 === a && (i = s(1), a = s(1));
                    var o = u(e, t, i, a);
                    if (o > 0) var l = (d = r.nodeOverlap * o) * i / (m = Math.sqrt(i * i + a * a)),
                        h = d * a / m; else {
                        var d, p = c(e, i, a), f = c(t, -1 * i, -1 * a), g = f.x - p.x, v = f.y - p.y,
                            y = g * g + v * v, m = Math.sqrt(y);
                        l = (d = (e.nodeRepulsion + t.nodeRepulsion) / y) * g / m, h = d * v / m
                    }
                    e.isLocked || (e.offsetX -= l, e.offsetY -= h), t.isLocked || (t.offsetX += l, t.offsetY += h)
                }
            }, u = function (e, t, n, r) {
                ...
                for (var n = 0; n < e.edgeSize; n++) {
                    var r = e.layoutEdges[n], i = e.idToIndex[r.sourceId], a = e.layoutNodes[i],
                        o = e.idToIndex[r.targetId], s = e.layoutNodes[o], l = s.positionX - a.positionX,
                        u = s.positionY - a.positionY;
                    if (0 !== l || 0 !== u) {
                        var h = c(a, l, u), d = c(s, -1 * l, -1 * u), p = d.x - h.x, f = d.y - h.y,
                            g = Math.sqrt(p * p + f * f), v = Math.pow(r.idealLength - g, 2) / r.elasticity;
                        if (0 !== g) var y = v * p / g, m = v * f / g; else y = 0, m = 0;
                ...
                for (var n = 0; n < e.graphSet.length; n++) {
                    ...
                    for (var u = 0; u < i; u++) {
                        ...
                        if (!c.isLocked) {
                            var h = a - c.positionX, d = o - c.positionY, p = Math.sqrt(h * h + d * d);
                            if (p > 1) {
                                var f = t.gravity * h / p, g = t.gravity * d / p;
                ...
                for (n = 0; n < e.nodeSize; n++) {
                    if (!(0 < (i = e.layoutNodes[n]).children.length || i.isLocked)) {
                        var r = g(i.offsetX, i.offsetY, e.temperature);
                        i.positionX += r.x, i.positionY += r.y, i.offsetX = 0, i.offsetY = 0, i.minX = i.positionX - i.width, i.maxX = i.positionX + i.width, i.minY = i.positionY - i.height, i.maxY = i.positionY + i.height, v(i, e)
                    }
                }
                for (n = 0; n < e.nodeSize; n++) {
                    var i;
                ...
                return function (e, t, n) {
                    o(e, t), h(e, t), d(e, t), p(e, t), f(e, t)
                }(r, i), r.temperature = r.temperature * i.coolingFactor, !(r.temperature < i.minTemp)
            }, m = 0;
            do {
                for (var b = 0; (b < i.refresh || 0 === i.refresh) && m < i.numIter;) {
                    var x;
                    if (!(x = y())) break;
                    b++, m++
                }
                !0 === i.animate && (t = r.layoutNodes, n = void 0, n = {type: "message", message: t}, a.trigger(n))
            } while (x && m + 1 < i.numIter);
            return function (e, t) {
                ...
                var h = 0, d = 0, p = 0, f = 0, g = Math.sqrt(l) * r.clientWidth / r.clientHeight;
                for (a = 0; a < i.length; a++) {
                    var v;
                    if (v = i[a]) {
                        for (u = 0; u < v.length; u++) (c = v[u]).isLocked || (c.positionX += h, c.positionY += d);
                        h += v.w + t.componentSpacing, p += v.w + t.componentSpacing, f = Math.max(f, v.h), p > g && (d += f + t.componentSpacing, h = 0, p = 0, f = 0)
                    }
                }
            }(0, i), r
        }).then(function (e) {
            o.layoutNodes = e.layoutNodes, r.stop(), c()
        });
        var c = function () {
            if (!0 === e.animate || !1 === e.animate) u({
                force: !0, next: function () {
                    n.one("layoutstop", e.stop), n.emit({type: "layoutstop", layout: n})
                }
            }); else {
                var t = e.eles.nodes(), r = ko(o, e, t);
                t.layoutPositions(n, e, r)
            }
        };
        return this
    ...
    var bo = function (e, t, n) {
        for (var r = n.eles.edges(), i = n.eles.nodes(), a = {
            ...
            boundingBox: bt(n.boundingBox ? n.boundingBox : {x1: 0, y1: 0, w: e.width(), h: e.height()})
        ...
        for (a.graphSet.push(v); f <= g;) {
            var b = d[f++], x = a.idToIndex[b], w = a.layoutNodes[x].children;
            if (w.length > 0) {
                a.graphSet.push(w);
        ...
        for (l = 0; l < a.edgeSize; l++) {
            ...
            var D = p(n.idealEdgeLength) ? n.idealEdgeLength(C) : n.idealEdgeLength,
                P = p(n.edgeElasticity) ? n.edgeElasticity(C) : n.edgeElasticity, T = a.idToIndex[S.sourceId],
                M = a.idToIndex[S.targetId];
            if (a.indexToGraph[T] != a.indexToGraph[M]) {
                for (var B = xo(S.sourceId, S.targetId, a), _ = a.graphSet[B], N = 0, I = a.layoutNodes[T]; -1 === _.indexOf(I.id);) I = a.layoutNodes[a.idToIndex[I.parentId]], N++;
        ...
        var r = n.layout, i = n.eles.nodes(), a = ko(e, n, i);
    ...
    Do.prototype.run = function () {
        var e = this.options, t = e, n = e.cy, r = t.eles.nodes().not(":parent");
        t.sort && (r = r.sort(t.sort));
        var i = bt(t.boundingBox ? t.boundingBox : {x1: 0, y1: 0, w: n.width(), h: n.height()});
        if (0 === i.h || 0 === i.w) r.layoutPositions(this, t, function (e) {
            return {x: i.x1, y: i.y1}
        }); else {
            var a = r.size(), o = Math.sqrt(a * i.h / i.w), s = Math.round(o), l = Math.round(i.w / i.h * o),
                u = function (e) {
                ...
                }, h = t.rows, d = null != t.cols ? t.cols : t.columns;
            if (null != h && null != d) s = h, l = d; else if (null != h && null == d) s = h, l = Math.ceil(a / s); else if (null == h && null != d) l = d, s = Math.ceil(a / l); else if (l * s > a) {
                var p = u(), f = c();
            ...
            var y = i.w / l, m = i.h / s;
            if (t.condense && (y = 0, m = 0), t.avoidOverlap) for (var b = 0; b < r.length; b++) {
                var x = r[b], w = x._private.position;
                null != w.x && null != w.y || (w.x = 0, w.y = 0);
                var E = x.layoutDimensions(t), k = t.avoidOverlapPadding, C = E.w + k, S = E.h + k;
            ...
            for (var D = {}, P = function (e, t) {
                ...
                var z = r[I], L = t.position(z);
                if (L && (void 0 !== L.row || void 0 !== L.col)) {
                    var A = {row: L.row, col: L.col};
                    if (void 0 === A.col) for (A.col = 0; P(A.row, A.col);) A.col++; else if (void 0 === A.row) for (A.row = 0; P(A.row, A.col);) A.row++;
            ...
            r.layoutPositions(this, t, function (e, t) {
                ...
                var a = N[e.id()];
                if (a) n = a.col * y + y / 2 + i.x1, r = a.row * m + m / 2 + i.y1; else {
                    for (; P(M, B);) _();
    ...
    Bo.prototype.run = function () {
        var e = this.options, t = e.eles.nodes(), n = p(e.positions);
    ...
    No.prototype.run = function () {
        var e = this.options, t = e.cy, n = e.eles.nodes().not(":parent"),
            r = bt(e.boundingBox ? e.boundingBox : {x1: 0, y1: 0, w: t.width(), h: t.height()});
        return n.layoutPositions(this, e, function (e, t) {
            return {x: r.x1 + Math.round(Math.random() * r.w), y: r.y1 + Math.round(Math.random() * r.h)}
        }), this
    };
    var Io = [{name: "breadthfirst", impl: co}, {name: "circle", impl: po}, {
        name: "concentric",
        impl: vo
    }, {name: "cose", impl: mo}, {name: "grid", impl: Do}, {name: "null", impl: To}, {
        name: "preset",
        impl: Bo
    }, {name: "random", impl: No}];
    ...
    zo.prototype = {
        recalculateRenderedStyle: Lo, notify: function () {
            this.notifications++
        }, init: Lo, isHeadless: function () {
            return !0
        }
    };
    var Ao = {
        ...
        projectIntoViewport: function (e, t) {
            ...
            var e = this.container, t = e.getBoundingClientRect(), n = a.getComputedStyle(e), r = function (e) {
                    return parseFloat(n.getPropertyValue(e))
                }, i = r("padding-left"), o = r("padding-right"), s = r("padding-top"), l = r("padding-bottom"),
                u = r("border-left-width"), c = r("border-right-width"), h = r("border-top-width"),
                d = (r("border-bottom-width"), e.clientWidth), p = e.clientHeight, f = i + o, g = s + l, v = u + c,
                y = t.width / (d + v), m = d - f, b = p - g, x = t.left + i + u, w = t.top + s + h;
            ...
            var i, a, o = this, s = this, l = s.getCachedZSortedEles(), u = [], c = s.cy.zoom(),
                h = s.cy.hasCompoundNodes(), d = (r ? 24 : 8) / c, p = (r ? 8 : 2) / c, f = (r ? 8 : 2) / c, g = 1 / 0;
            ...
            function m(n) {
                var r, i = n._private, a = i.rscratch, l = n.pstyle("width").pfValue, c = n.pstyle("arrow-scale").value,
                    p = l / 2 + d, f = p * p, g = 2 * p, m = i.source, b = i.target;
                if ("segments" === a.edgeType || "straight" === a.edgeType || "haystack" === a.edgeType) {
                    for (var x = a.allpts, w = 0; w + 3 < x.length; w += 2) if (Nt(e, t, x[w], x[w + 1], x[w + 2], x[w + 3], g) && f > (r = Ot(e, t, x[w], x[w + 1], x[w + 2], x[w + 3]))) return v(n, r), !0
                } else if ("bezier" === a.edgeType || "multibezier" === a.edgeType || "self" === a.edgeType || "compound" === a.edgeType) for (x = a.allpts, w = 0; w + 5 < a.allpts.length; w += 4) if (It(e, t, x[w], x[w + 1], x[w + 2], x[w + 3], x[w + 4], x[w + 5], g) && f > (r = At(e, t, x[w], x[w + 1], x[w + 2], x[w + 3], x[w + 4], x[w + 5]))) return v(n, r), !0;
                ...
                for (w = 0; w < k.length; w++) {
                    ...
                    if (S.roughCollide(e, t, E, C.angle, {x: C.x, y: C.y}, D, d) && S.collide(e, t, E, C.angle, {
                        x: C.x,
                        y: C.y
                    }, D, d)) return v(n), !0
                }
            ...
            function x(n, r) {
                ...
                i = r ? r + "-" : "";
                var s = n.pstyle(i + "label").value;
                if ("yes" === n.pstyle("text-events").strValue && s) {
                    var l = a.rstyle, u = n.pstyle("text-border-width").pfValue,
                        c = n.pstyle("text-background-padding").pfValue, h = b(l, "labelWidth", r) + u + 2 * o + 2 * c,
                        d = b(l, "labelHeight", r) + u + 2 * o + 2 * c, p = b(l, "labelX", r), g = b(l, "labelY", r),
                        y = b(a.rscratch, "labelAngle", r), m = p - h / 2, x = p + h / 2, w = g - d / 2, E = g + d / 2;
                    if (y) {
                        var k = Math.cos(y), C = Math.sin(y), S = function (e, t) {
                                return {x: (e -= p) * k - (t -= g) * C + p, y: e * C + t * k + g}
                            }, D = S(m, w), P = S(m, E), T = S(x, w), M = S(x, E),
                            B = [D.x, D.y, T.x, T.y, M.x, M.y, P.x, P.y];
                        if (Rt(e, t, B)) return v(n), !0
                    } else {
                        if (Tt({w: h, h: d, x1: m, x2: x, y1: w, y2: E}, e, t)) return v(n), !0
                    }
                }
            }
            ...
            for (var i = this.getCachedZSortedEles().interactive, a = [], o = Math.min(e, n), s = Math.max(e, n), l = Math.min(t, r), u = Math.max(t, r), c = bt({
                x1: e = o,
                y1: t = l,
                x2: n = s,
                y2: r = u
                ...
                var d = i[h];
                if (d.isNode()) {
                    var p = d, f = p.boundingBox({includeNodes: !0, includeEdges: !1, includeLabels: !1});
                    Pt(c, f) && !Bt(f, c) && a.push(p)
                } else {
                    var g = d, v = g._private, y = v.rscratch;
                    if (null != y.startX && null != y.startY && !Tt(c, y.startX, y.startY)) continue;
                    if (null != y.endX && null != y.endY && !Tt(c, y.endX, y.endY)) continue;
                    if ("bezier" === y.edgeType || "multibezier" === y.edgeType || "self" === y.edgeType || "compound" === y.edgeType || "segments" === y.edgeType || "haystack" === y.edgeType) {
                        for (var m = v.rstyle.bezierPts || v.rstyle.linePts || v.rstyle.haystackPts, b = !0, x = 0; x < m.length; x++) if (!Mt(c, m[x])) {
                            b = !1;
                            break
                        }
                        b && a.push(g)
                    } else "haystack" !== y.edgeType && "straight" !== y.edgeType || a.push(g)
                }
            }
            return a
        }
        ...
        calculateArrowAngles: function (e) {
            var t, n, r, i, a, o, s = e._private.rscratch, l = "haystack" === s.edgeType, u = "bezier" === s.edgeType,
                c = "multibezier" === s.edgeType, h = "segments" === s.edgeType, d = "compound" === s.edgeType,
                p = "self" === s.edgeType;
            if (l ? (r = s.haystackPts[0], i = s.haystackPts[1], a = s.haystackPts[2], o = s.haystackPts[3]) : (r = s.arrowStartX, i = s.arrowStartY, a = s.arrowEndX, o = s.arrowEndY), g = s.midX, v = s.midY, h) t = r - s.segpts[0], n = i - s.segpts[1]; else if (c || d || p || u) {
                var f = s.allpts;
                t = r - gt(f[0], f[2], f[4], .1), n = i - gt(f[1], f[3], f[5], .1)
            } else t = r - g, n = i - v;
            s.srcArrowAngle = ut(t, n);
            var g = s.midX, v = s.midY;
            if (l && (g = (r + a) / 2, v = (i + o) / 2), t = a - r, n = o - i, h) if ((f = s.allpts).length / 2 % 2 == 0) {
                ...
                if (s.ctrlpts.length / 2 % 2 == 0) {
                    ...
                    x = gt(f[D], f[S], f[C], 0), w = gt(f[D + 1], f[S + 1], f[C + 1], 0), E = gt(f[D], f[S], f[C], 1e-4), k = gt(f[D + 1], f[S + 1], f[C + 1], 1e-4)
                } else {
                    var S, D;
                    C = (S = f.length / 2 - 1) + 2;
                    x = gt(f[D = S - 2], f[S], f[C], .4999), w = gt(f[D + 1], f[S + 1], f[C + 1], .4999), E = gt(f[D], f[S], f[C], .5), k = gt(f[D + 1], f[S + 1], f[C + 1], .5)
                }
                t = E - x, n = k - w
            }
            (s.midtgtArrowAngle = ut(t, n), s.midDispX = t, s.midDispY = n, t *= -1, n *= -1, h) && ((f = s.allpts).length / 2 % 2 == 0 || (t = -(f[b = (m = f.length / 2 - 1) + 2] - f[m]), n = -(f[b + 1] - f[m + 1])));
            if (s.midsrcArrowAngle = ut(t, n), h) t = a - s.segpts[s.segpts.length - 2], n = o - s.segpts[s.segpts.length - 1]; else if (c || d || p || u) {
                var P = (f = s.allpts).length;
                t = a - gt(f[P - 6], f[P - 4], f[P - 2], .9), n = o - gt(f[P - 5], f[P - 3], f[P - 1], .9)
            } else t = a - g, n = o - v;
            s.tgtArrowAngle = ut(t, n)
        }
    };
    Ro.getArrowWidth = Ro.getArrowHeight = function (e, t) {
    ...
    Fo.findHaystackPoints = function (e) {
        for (var t = 0; t < e.length; t++) {
            ...
            var o = r.source, s = r.target, l = o.position(), u = s.position(), c = o.width(), h = s.width(),
                d = o.height(), p = s.height(), f = n.pstyle("haystack-radius").value / 2;
        ...
        for (var c = 0; c < u; c++) {
            var h = s.pfValue[c], d = l.pfValue[c], p = 1 - h, f = h, g = "node-position" === o ? r : i,
        ...
        var a = t.srcPos, o = t.tgtPos, s = t.srcW, l = t.srcH, u = t.tgtW, c = t.tgtH,
            h = e.pstyle("control-point-step-size").pfValue, d = e.pstyle("control-point-distances"),
            p = d ? d.pfValue[0] : void 0, f = n, g = h;
        r && (f = 0, g = p);
        ...
        var a = e._private.rscratch, o = t.vectorNormInverse, s = t.posPts, l = t.intersectionPts,
            ...
            h = e.pstyle("control-point-distances"), d = e.pstyle("control-point-weights"),
            p = h && d ? Math.min(h.value.length, d.value.length) : 1, f = h ? h.pfValue[0] : void 0, g = d.value[0],
            v = r;
        a.edgeType = v ? "multibezier" : "bezier", a.ctrlpts = [];
        for (var y = 0; y < p; y++) {
            var m = (.5 - t.eles.length / 2 + n) * c * (i ? -1 : 1), b = void 0, x = ht(m);
        ...
        var r = t.posPts, i = t.srcW, a = t.srcH, o = t.tgtW, s = t.tgtH,
            ...
            h = e.pstyle("taxi-turn"), d = h.pfValue, p = e.pstyle("taxi-turn-min-distance").pfValue,
            f = "%" === h.units, g = l ? (i + o) / 2 : 0, v = l ? (a + s) / 2 : 0, y = r.x2 - r.x1, m = r.y2 - r.y1,
            b = function (e, t) {
        ...
        var k = "vertical" === u, C = k ? w : x, S = k ? m : y, D = ht(S), P = !1;
        E && f || !("downward" === c && S < 0 || "upward" === c && S > 0 || "leftward" === c && S > 0 || "rightward" === c && S < 0) || (C = (D *= -1) * Math.abs(C), P = !0);
        var T = f ? d * C : d * D, M = function (e) {
            return Math.abs(e) < p || Math.abs(e) >= Math.abs(C)
        }, B = M(T), _ = M(C - T);
        if ((B || _) && !P) if (k) {
            var N = Math.abs(S) <= a / 2, I = Math.abs(y) <= o / 2;
            if (N) {
                var z = (r.x1 + r.x2) / 2, L = r.y1, A = r.y2;
                n.segpts = [z, L, z, A]
            } else if (I) {
                var O = (r.y1 + r.y2) / 2, R = r.x1, F = r.x2;
                n.segpts = [R, O, F, O]
            } else n.segpts = [r.x1, r.y2]
        } else {
            var V = Math.abs(S) <= i / 2, q = Math.abs(m) <= s / 2;
            if (V) {
                var j = (r.y1 + r.y2) / 2, Y = r.x1, X = r.x2;
                n.segpts = [Y, j, X, j]
            } else if (q) {
                var W = (r.x1 + r.x2) / 2, H = r.y1, K = r.y2;
                n.segpts = [W, H, W, K]
            } else n.segpts = [r.x2, r.y1]
        } else if (k) {
            var G = r.y1 + T + (l ? a / 2 * D : 0), Z = r.x1, U = r.x2;
            n.segpts = [Z, G, U, G]
        } else {
            var $ = r.x1 + T + (l ? i / 2 * D : 0), Q = r.y1, J = r.y2;
            n.segpts = [$, Q, $, J]
        }
        ...
        if ("bezier" === n.edgeType) {
            var r = t.srcPos, i = t.tgtPos, a = t.srcW, o = t.srcH, s = t.tgtW, l = t.tgtH, u = t.srcShape,
                c = t.tgtShape, h = !v(n.startX) || !v(n.startY), d = !v(n.arrowStartX) || !v(n.arrowStartY),
                p = !v(n.endX) || !v(n.endY), f = !v(n.arrowEndX) || !v(n.arrowEndY),
                g = 3 * (this.getArrowWidth(e.pstyle("width").pfValue, e.pstyle("arrow-scale").value) * this.arrowShapeWidth),
                y = dt({x: n.ctrlpts[0], y: n.ctrlpts[1]}, {x: n.startX, y: n.startY}), m = y < g,
                b = dt({x: n.ctrlpts[0], y: n.ctrlpts[1]}, {x: n.endX, y: n.endY}), x = b < g, w = !1;
            if (h || d || m) {
                w = !0;
        ...
        if ("multibezier" === t.edgeType || "bezier" === t.edgeType || "self" === t.edgeType || "compound" === t.edgeType) {
            ...
            var r;
            t.allpts.push(t.endX, t.endY), t.ctrlpts.length / 2 % 2 == 0 ? (r = t.allpts.length / 2 - 1, t.midX = t.allpts[r], t.midY = t.allpts[r + 1]) : (r = t.allpts.length / 2 - 3, .5, t.midX = gt(t.allpts[r], t.allpts[r + 2], t.allpts[r + 4], .5), t.midY = gt(t.allpts[r + 1], t.allpts[r + 3], t.allpts[r + 5], .5))
        ...
        var t = this;
        if (e && 0 !== e.length) {
            for (var n = this, r = n.cy.hasCompoundNodes(), i = new ze, a = [], o = [], s = 0; s < e.length; s++) {
                ...
                if (!l.removed() && l.takesUpSpace()) if ("haystack" !== c) {
                    var h = "unbundled-bezier" === c || "segments" === c || "straight" === c || "taxi" === c,
                        d = "unbundled-bezier" === c || "bezier" === c, p = u.source.poolIndex(),
                        f = u.target.poolIndex(), g = (h ? -1 : 1) * ce([p, f].sort()), y = i.get(g);
                    null == y && (y = {eles: []}, i.set(g, y), a.push(g)), y.eles.push(l), h && (y.hasUnbundled = !0), d && (y.hasBezier = !0)
                } else o.push(l)
            }
            for (var m = function (e) {
                ...
                var c = s.eles[0], h = c.source(), d = c.target();
                if (h.poolIndex() > d.poolIndex()) {
                    var p = h;
                    h = d, d = p
                }
                var f = s.srcPos = h.position(), g = s.tgtPos = d.position(), y = s.srcW = h.outerWidth(),
                    m = s.srcH = h.outerHeight(), b = s.tgtW = d.outerWidth(), x = s.tgtH = d.outerHeight(),
                    w = s.srcShape = n.nodeShapes[t.getNodeShape(h)], E = s.tgtShape = n.nodeShapes[t.getNodeShape(d)];
                s.dirCounts = {
                    north: 0,
                    west: 0,
                    south: 0,
                ...
                for (var k = 0; k < s.eles.length; k++) {
                    var C = s.eles[k], S = C[0]._private.rscratch, D = C.pstyle("curve-style").value,
                        P = "unbundled-bezier" === D || "segments" === D || "taxi" === D, T = !h.same(C.source());
                    if (!s.calculatedIntersection && h !== d && (s.hasBezier || s.hasUnbundled)) {
                        s.calculatedIntersection = !0;
                        var M = w.intersectLine(f.x, f.y, y, m, g.x, g.y, 0), B = s.srcIntn = M,
                            ...
                            F = s.vectorNorm = {x: R.x / O, y: R.y / O}, V = {x: -F.y, y: F.x};
                        s.nodesOverlap = !v(O) || E.checkPoint(M[0], M[1], 0, b, x, g.x, g.y) || w.checkPoint(_[0], _[1], 0, y, m, f.x, f.y), s.vectorNormInverse = V, l = {
        ...
        var t = e[0]._private.rscratch;
        if ("segments" === t.edgeType) return this.recalculateRenderedStyle(e), Vo(t.segpts)
    }, Fo.getControlPoints = function (e) {
        var t = e[0]._private.rscratch, n = t.edgeType;
        if ("bezier" === n || "multibezier" === n || "self" === n || "compound" === n) return this.recalculateRenderedStyle(e), Vo(t.ctrlpts)
    ...
    var qo = {
        manualEndptToPx: function (e, t) {
            ...
            var t, n, r, i, a, o = this, s = e.source()[0], l = e.target()[0], u = s.position(), c = l.position(),
                h = e.pstyle("target-arrow-shape").value, d = e.pstyle("source-arrow-shape").value,
                p = e.pstyle("target-distance-from-node").pfValue, f = e.pstyle("source-distance-from-node").pfValue,
                g = e.pstyle("curve-style").value, y = e._private.rscratch, m = y.edgeType,
            ...
            if ("inside-to-node" === M) t = [c.x, c.y]; else if (T.units) t = this.manualEndptToPx(l, T); else if ("outside-to-line" === M) t = y.tgtIntn; else if ("outside-to-node" === M || "outside-to-node-or-label" === M ? i = n : "outside-to-line" !== M && "outside-to-line-or-label" !== M || (i = [u.x, u.y]), t = o.nodeShapes[this.getNodeShape(l)].intersectLine(c.x, c.y, l.outerWidth(), l.outerHeight(), i[0], i[1], 0), "outside-to-node-or-label" === M || "outside-to-line-or-label" === M) {
                var N = l._private.rscratch, I = N.labelWidth, z = N.labelHeight, L = N.labelX, A = N.labelY,
                    O = l.pstyle("text-valign").value;
                "top" === O ? A -= z / 2 : "bottom" === O && (A += z / 2);
                var R = l.pstyle("text-halign").value;
                "left" === R ? L -= I / 2 : "right" === R && (L += I / 2);
                var F = o.nodeShapes.rectangle.intersectLine(L, A, I, z, i[0], i[1], 0), V = u, q = pt(V, rt(t));
                pt(V, rt(F)) < q && (t = F)
            }
            var j = Gt(t, n, o.arrowShapes[h].spacing(e) + p), Y = Gt(t, n, o.arrowShapes[h].gap(e) + p);
            if (y.endX = Y[0], y.endY = Y[1], y.arrowEndX = j[0], y.arrowEndY = j[1], "inside-to-node" === P) t = [u.x, u.y]; else if (D.units) t = this.manualEndptToPx(s, D); else if ("outside-to-line" === P) t = y.srcIntn; else if ("outside-to-node" === P || "outside-to-node-or-label" === P ? a = r : "outside-to-line" !== P && "outside-to-line-or-label" !== P || (a = [c.x, c.y]), t = o.nodeShapes[this.getNodeShape(s)].intersectLine(u.x, u.y, s.outerWidth(), s.outerHeight(), a[0], a[1], 0), "outside-to-node-or-label" === P || "outside-to-line-or-label" === P) {
                var X = s._private.rscratch, W = X.labelWidth, H = X.labelHeight, K = X.labelX, G = X.labelY,
                    Z = s.pstyle("text-valign").value;
                "top" === Z ? G -= H / 2 : "bottom" === Z && (G += H / 2);
                var U = s.pstyle("text-halign").value;
                "left" === U ? K -= W / 2 : "right" === U && (K += W / 2);
                var $ = o.nodeShapes.rectangle.intersectLine(K, G, W, H, a[0], a[1], 0), Q = c, J = pt(Q, rt(t));
                pt(Q, rt($)) < J && (t = $)
            }
            var ee = Gt(t, r, o.arrowShapes[d].spacing(e) + f), te = Gt(t, r, o.arrowShapes[d].gap(e) + f);
    ...
    jo.storeEdgeProjections = function (e) {
        ...
        if (t.rstyle.bezierPts = null, t.rstyle.linePts = null, t.rstyle.haystackPts = null, "multibezier" === r || "bezier" === r || "self" === r || "compound" === r) {
            t.rstyle.bezierPts = [];
            for (var i = 0; i + 5 < n.allpts.length; i += 4) Yo(this, e, n.allpts.slice(i, i + 6))
        } else if ("segments" === r) {
        ...
        recalculateNodeLabelProjection: function (e) {
            ...
            if (!k(t)) {
                var n, r, i = e._private, a = e.width(), o = e.height(), s = e.padding(), l = e.position(),
                    u = e.pstyle("text-halign").strValue, c = e.pstyle("text-valign").strValue, h = i.rscratch,
                    d = i.rstyle;
                switch (u) {
                    case"left":
                        n = l.x - a / 2 - s;
    ...
    Xo.recalculateEdgeLabelProjections = function (e) {
                    ...
                    switch (r.edgeType) {
                        ...
                        case"multibezier":
                            for (var h, d = function e() {
                                ...
                                function h(e, t, n, r, i) {
                                    var a = dt(t, n), o = e.segments[e.segments.length - 1], s = {
                                        p0: t,
                                        p1: n,
                                        t0: r,
                                        t1: i,
                            ...
                            var x = h.cp, w = h.segment, E = (c - p) / w.length, k = w.t1 - w.t0,
                                C = u ? w.t0 + k * E : w.t1 - k * E;
                            C = mt(0, C, 1), t = vt(x.p0, x.p1, x.p2, C), l = function (e, t, n, r) {
                                var i = mt(0, r - .001, 1), a = mt(0, r + .001, 1), o = vt(e, t, n, i),
                                    s = vt(e, t, n, a);
                                return Ho(o, s)
                            }(x.p0, x.p1, x.p2, C);
                            break;
                        ...
                        case"haystack":
                            for (var S, D, P, T, M = 0, B = r.allpts.length, _ = 0; _ + 3 < B && (u ? (P = {
                                ...
                                x: r.allpts[B - 4 - _],
                                y: r.allpts[B - 3 - _]
                            }), D = M, !((M += S = dt(P, T)) >= c)); _ += 2) ;
                            var N = (c - D) / S;
                            N = mt(0, N, 1), t = yt(P, T, N), l = Ho(P, T)
                    }
        ...
        var n = e._private, r = this.getLabelText(e, t), i = this.calculateLabelDimensions(e, r),
            ...
            o = "wrap" !== e.pstyle("text-wrap").strValue ? 1 : Ne(n.rscratch, "labelWrapCachedLines", t).length || 1,
            s = i.height / o, l = s * a, u = i.width, c = i.height + (o - 1) * (a - 1) * s;
        Ie(n.rstyle, "labelWidth", t, u), Ie(n.rscratch, "labelWidth", t, u), Ie(n.rstyle, "labelHeight", t, c), Ie(n.rscratch, "labelHeight", t, c), n.rscratch.labelLineHeight = l
        ...
        var n = he(t, e._private.labelDimsKey), r = this.labelDimCache || (this.labelDimCache = []), i = r[n];
        if (null != i) return i;
        var a = e.pstyle("font-style").strValue, o = 1 * e.pstyle("font-size").pfValue + "px",
            s = e.pstyle("font-family").strValue, l = e.pstyle("font-weight").strValue, u = this.labelCalcDiv;
    ...
    Ko.getNodeShape = function (e) {
        ...
        if ("cutrectangle" === t && (e.width() < 28 || e.height() < 28)) return Go || (Ce("The `cutrectangle` node shape can not be used at small sizes so `rectangle` is used instead"), Go = !0), "rectangle";
    ...
    var Zo = {
            ...
            var i = function (i) {
                if (i) {
                    for (var a = n.onUpdateEleCalcsFns, o = 0; o < t.length; o++) {
                        var s = t[o];
                        s.isNode() && !s._private.rstyle.clean && r(s.connectedEdges())
                    }
        ...
        updateCachedGrabbedEles: function () {
            ...
            if (e || !this.cachedZSortedEles) {
                ...
                t.sort($i), t.interactive = t.filter(function (e) {
    ...
    [Oo, Ro, Fo, qo, jo, Xo, Ko, Zo, Uo].forEach(function (e) {
        I($o, e)
    });
    var Qo = {
    ...
    Jo.binder = function (e) {
    ...
    }, Jo.nodeIsDraggable = function (e) {
        return e && e.isNode() && !e.locked() && e.grabbable()
    }, Jo.nodeIsGrabbable = function (e) {
        ...
        var e = this, t = function (e) {
            ...
            var r = !0;
            if (e.cy.hasCompoundNodes() && t && t.isEdge()) for (var i = 0; n && i < n.length; i++) {
            ...
            }(t, n), h(t, {inDragLayer: n.inDragLayer}), e.updateCachedGrabbedEles()
        }, u = l, c = function (t) {
        ...
        p && (e.styleObserver = new MutationObserver(f), e.styleObserver.observe(e.container, {attributes: !0})), e.registerBinding(window, "resize", f);
        var g = function () {
        ...
        e.registerBinding(e.container, "mousedown", function (t) {
            if (y(t)) {
                ...
                var r = e.cy, i = [t.clientX, t.clientY], a = e.projectIntoViewport(i[0], i[1]), s = e.selection,
                    c = e.findNearestElements(a[0], a[1], !0, !1), h = c[0], p = e.dragData.possibleDragElements;
                ...
                if (3 == t.which) {
                    ...
                    if (h && h.activate(), null != h && e.nodeIsGrabbable(h)) {
                        ...
                        if (o(h), h.selected()) {
                            ...
                            l(v, {addToList: p}), h.emit(g("grabon")), v.forEach(function (e) {
                                e.emit(g("grab"))
                            })
                        } else p = e.dragData.possibleDragElements = r.collection(), u(h, {addToList: p}), h.emit(g("grabon")).emit(g("grab"));
                    ...
                    e.hoverData.down = h, e.hoverData.downs = c, e.hoverData.downTime = (new Date).getTime(), n(h, ["mousedown", "tapstart", "vmousedown"], t, {
                        ...
                        x: a[0],
                        y: a[1]
                    }, e.redrawHint("select", !0), e.redraw()) : h.isEdge() && (s[4] = 1), e.hoverData.tapholdCancelled = !1, clearTimeout(e.hoverData.tapholdTimeout), e.hoverData.tapholdTimeout = setTimeout(function () {
            ...
            if (e.hoverData.capture || y(t)) {
                var a = !1, o = e.cy, s = o.zoom(), u = [t.clientX, t.clientY], h = e.projectIntoViewport(u[0], u[1]),
                    d = e.hoverData.mdownPos, p = e.hoverData.mdownGPos, f = e.selection, g = null;
                e.hoverData.draggingEles || e.hoverData.dragging || e.hoverData.selecting || (g = e.findNearestElement(h[0], h[1], !0, !1));
                var m, b = e.hoverData.last, x = e.hoverData.down, w = [h[0] - f[2], h[1] - f[3]],
                ...
                a = !0, n(g, ["mousemove", "vmousemove", "tapdrag"], t, {x: h[0], y: h[1]});
                var T = function () {
                ...
                if (3 === e.hoverData.which) {
                    if (m) {
                        var M = {originalEvent: t, type: "cxtdrag", position: {x: h[0], y: h[1]}};
                    ...
                    if (a = !0, o.panningEnabled() && o.userPanningEnabled()) {
                        ...
                        if (e.hoverData.justStartedPan) {
                            ...
                            B = {x: (h[0] - _[0]) * s, y: (h[1] - _[1]) * s}, e.hoverData.justStartedPan = !1
                    ...
                    if (x && x.isEdge() && x.active() && x.unactivate(), x && x.grabbed() || g == b || (b && n(b, ["mouseout", "tapdragout"], t, {
                        x: h[0],
                        y: h[1]
                    }), g && n(g, ["mouseover", "tapdragover"], t, {
                        x: h[0],
                        y: h[1]
                    }), e.hoverData.last = g), x) if (m) {
                        if (o.boxSelectionEnabled() && P) x && x.grabbed() && (c(E), x.emit("freeon"), E.emit("free"), e.dragData.didDrag && (x.emit("dragfreeon"), E.emit("dragfree"))), T(); else if (x && x.grabbed() && e.nodeIsDraggable(x)) {
        ...
        e.registerBinding(e.container, "wheel", function (t) {
            if (!e.scrollingPage) {
                var n, r = e.cy, i = e.projectIntoViewport(t.clientX, t.clientY),
        ...
        if (e.registerBinding(e.container, "touchstart", _ = function (t) {
            if (y(t)) {
                ...
                if (t.touches[2]) ; else if (t.touches[1]) ; else if (t.touches[0]) {
                    var _ = e.findNearestElements(i[0], i[1], !0, !0), N = _[0];
                    if (null != N && (N.activate(), e.touchData.start = N, e.touchData.starts = _, e.nodeIsGrabbable(N))) {
                        var I = e.dragData.touchDragEles = r.collection(), z = null;
                        e.redrawHint("eles", !0), e.redrawHint("drag", !0), N.selected() ? (z = r.$(function (t) {
                            return t.selected() && e.nodeIsGrabbable(t)
                        }), l(z, {addToList: I})) : u(N, {addToList: I}), o(N);
                        var O = function (e) {
                ...
                if (t.touches.length >= 1) {
                    for (var R = e.touchData.startPosition = [], F = 0; F < i.length; F++) R[F] = a[F] = i[F];
                    var V = t.touches[0];
                    e.touchData.startGPosition = [V.clientX, V.clientY]
                }
            }
        }, !1), e.registerBinding(window, "touchmove", N = function (t) {
            var r = e.touchData.capture;
            if (r || y(t)) {
                var a = e.selection, o = e.cy, s = e.touchData.now, u = e.touchData.earlier, h = o.zoom();
                if (t.touches[0]) {
                ...
                if (r && t.touches[0] && f) {
                    ...
                    var T = t.touches[0].clientX - f[0], M = T * T, _ = t.touches[0].clientY - f[1];
                    p = M + _ * _ >= e.touchTapThreshold2
                }
                if (r && e.touchData.cxt) {
                    t.preventDefault();
                    var N = t.touches[0].clientX - D, I = t.touches[0].clientY - P, z = t.touches[1].clientX - D,
                        O = t.touches[1].clientY - P, R = A(N, I, z, O);
                    if (R / k >= 2.25 || R >= 22500) {
                        e.touchData.cxt = !1, e.data.bgActivePosistion = void 0, e.redrawHint("select", !0);
                        var F = {originalEvent: t, type: "cxttapend", position: {x: s[0], y: s[1]}};
                        e.touchData.start ? (e.touchData.start.unactivate().emit(F), e.touchData.start = null) : o.emit(F)
                    }
                }
                if (r && e.touchData.cxt) {
                    F = {originalEvent: t, type: "cxtdrag", position: {x: s[0], y: s[1]}};
                    ...
                    var V = e.findNearestElement(s[0], s[1], !0, !0);
                    e.touchData.cxtOver && V === e.touchData.cxtOver || (e.touchData.cxtOver && e.touchData.cxtOver.emit({
                        originalEvent: t,
                        type: "cxtdragout",
                        position: {x: s[0], y: s[1]}
                    }), e.touchData.cxtOver = V, V && V.emit({
                        originalEvent: t,
                        type: "cxtdragover",
                        position: {x: s[0], y: s[1]}
                    }))
                    ...
                    type: "boxstart",
                    position: {x: s[0], y: s[1]}
                }), e.touchData.selecting = !0, e.redrawHint("select", !0), a && 0 !== a.length && void 0 !== a[0] ? (a[2] = (s[0] + s[2] + s[4]) / 3, a[3] = (s[1] + s[3] + s[5]) / 3) : (a[0] = (s[0] + s[2] + s[4]) / 3, a[1] = (s[1] + s[3] + s[5]) / 3, a[2] = (s[0] + s[2] + s[4]) / 3 + 1, a[3] = (s[1] + s[3] + s[5]) / 3 + 1), a[4] = 1, e.touchData.selecting = !0, e.redraw(); else if (r && t.touches[1] && o.zoomingEnabled() && o.panningEnabled() && o.userZoomingEnabled() && o.userPanningEnabled()) {
                    ...
                    var Y = e.touchData.start,
                        ...
                        W = X / E;
                    if (B) {
                        var H = (N - m + (z - x)) / 2, K = (I - b + (O - w)) / 2, G = o.zoom(), Z = G * W, U = o.pan(),
                            $ = S[0] * G + U.x, Q = S[1] * G + U.y,
                    ...
                    if (e.hoverData.draggingEles || e.swipePanning || (V = e.findNearestElement(s[0], s[1], !0, !0)), r && null != te && t.preventDefault(), r && null != te && e.nodeIsDraggable(te)) if (p) {
                        ee = e.dragData.touchDragEles;
                        var re = !e.dragData.didDrag;
                        re && l(ee, {inDragLayer: !0}), e.dragData.didDrag = !0;
                        var ie = {x: 0, y: 0};
                        if (v(g[0]) && v(g[1])) if (ie.x += g[0], ie.y += g[1], re) e.redrawHint("eles", !0), (ae = e.touchData.dragDelta) && v(ae[0]) && v(ae[1]) && (ie.x += ae[0], ie.y += ae[1]);
                    ...
                    if (n(te || V, ["touchmove", "tapdrag", "vmousemove"], t, {
                        x: s[0],
                        y: s[1]
                    }), te && te.grabbed() || V == ne || (ne && ne.emit({
                        originalEvent: t,
                        type: "tapdragout",
                        position: {x: s[0], y: s[1]}
                    }), V && V.emit({
                        ...
                        type: "tapdragover",
                        position: {x: s[0], y: s[1]}
                    })), e.touchData.last = V, r) for (q = 0; q < s.length; q++) s[q] && e.touchData.startPosition[q] && p && (e.touchData.singleTouchMoved = !0);
                    if (r && (null == te || te.isEdge()) && o.panningEnabled() && o.userPanningEnabled()) {
                        i(te, e.touchData.starts) && (t.preventDefault(), e.swipePanning ? o.panBy({
                            x: g[0] * h,
                            y: g[1] * h
                        }) : p && (e.swipePanning = !0, o.panBy({
                            x: T * h,
                            y: _ * h
                        }), te && (te.unactivate(), e.data.bgActivePosistion || (e.data.bgActivePosistion = rt(e.touchData.startPosition)), e.redrawHint("select", !0), e.touchData.start = null)));
                        d = e.projectIntoViewport(t.touches[0].clientX, t.touches[0].clientY);
                        s[0] = d[0], s[1] = d[1]
                    }
                }
            ...
            if (e.touchData.capture) {
                ...
                var o, s = e.cy, l = s.zoom(), u = e.touchData.now, h = e.touchData.earlier;
                if (r.touches[0]) {
            ...
            e.registerBinding(e.container, "pointerdown", function (e) {
                j(e) || (e.preventDefault(), F(e), q(e), _(e))
                ...
                j(e) || (e.preventDefault(), function (e) {
        ...
        generatePolygon: function (e, t) {
            return this.nodeShapes[e] = {
                renderer: this, name: e, points: t, draw: function (e, t, n, r, i) {
                    ...
                    return Kt(i, a, this.points, e, t, n / 2, r / 2, o)
                }, checkPoint: function (e, t, n, r, i, a, o) {
                    return Ft(e, t, this.points, a, o, r, i, [0, -1], n)
                }
            }
            ...
            return this.nodeShapes.ellipse = {
                renderer: this, name: "ellipse", draw: function (e, t, n, r, i) {
                    ...
                    return jt(i, a, e, t, n / 2 + o, r / 2 + o)
                }, checkPoint: function (e, t, n, r, i, a, o) {
                    return Yt(e, t, r, i, a, o, n)
                }
            }
            ...
            return this.nodeShapes["round-rectangle"] = this.nodeShapes.roundrectangle = {
                ...
                intersectLine: function (e, t, n, r, i, a, o) {
                    return _t(i, a, e, t, n, r, o)
                },
                checkPoint: function (e, t, n, r, i, a, o) {
                    var s = Qt(r, i), l = 2 * s;
                    return !!Ft(e, t, this.points, a, o, r, i - l, [0, -1], n) || (!!Ft(e, t, this.points, a, o, r - l, i, [0, -1], n) || (!!Yt(e, t, l, l, a - r / 2 + s, o - i / 2 + s, n) || (!!Yt(e, t, l, l, a + r / 2 - s, o - i / 2 + s, n) || (!!Yt(e, t, l, l, a + r / 2 - s, o + i / 2 - s, n) || !!Yt(e, t, l, l, a - r / 2 + s, o + i / 2 - s, n)))))
                }
            }
            ...
            return this.nodeShapes["cut-rectangle"] = this.nodeShapes.cutrectangle = {
                ...
                checkPoint: function (e, t, n, r, i, a, o) {
                    if (Ft(e, t, this.points, a, o, r, i - 2 * this.cornerLength, [0, -1], n)) return !0;
                    if (Ft(e, t, this.points, a, o, r - 2 * this.cornerLength, i, [0, -1], n)) return !0;
                    var s = this.generateCutTrianglePts(r, i, a, o);
                    return Rt(e, t, s.topLeft) || Rt(e, t, s.topRight) || Rt(e, t, s.bottomRight) || Rt(e, t, s.bottomLeft)
                }
            }
            ...
            return this.nodeShapes.barrel = {
                ...
                intersectLine: function (e, t, n, r, i, a, o) {
                    var s = this.generateBarrelBezierPts(n + 2 * o, r + 2 * o, e, t), l = function (e) {
                        var t = vt({x: e[0], y: e[1]}, {x: e[2], y: e[3]}, {x: e[4], y: e[5]}, .15),
                            n = vt({x: e[0], y: e[1]}, {x: e[2], y: e[3]}, {x: e[4], y: e[5]}, .5),
                            r = vt({x: e[0], y: e[1]}, {x: e[2], y: e[3]}, {x: e[4], y: e[5]}, .85);
                ...
                generateBarrelBezierPts: function (e, t, n, r) {
                    var i = t / 2, a = e / 2, o = n - a, s = n + a, l = r - i, u = r + i, c = en(e, t),
                        h = c.heightOffset, d = c.widthOffset, p = c.ctrlPtOffsetPct * e, f = {
                ...
                checkPoint: function (e, t, n, r, i, a, o) {
                    var s = en(r, i), l = s.heightOffset, u = s.widthOffset;
                    if (Ft(e, t, this.points, a, o, r, i - 2 * l, [0, -1], n)) return !0;
                    if (Ft(e, t, this.points, a, o, r - 2 * u, i, [0, -1], n)) return !0;
                    for (var c = this.generateBarrelBezierPts(r, i, a, o), h = function (e, t, n) {
                        var r = n[4], i = n[2], a = n[0], o = n[5], s = n[1], l = Math.min(r, a), u = Math.max(r, a),
                            c = Math.min(o, s), h = Math.max(o, s);
                        if (l <= e && e <= u && c <= t && t <= h) {
                            var d = Jt(r, i, a), p = zt(d[0], d[1], d[2], e).filter(function (e) {
                                return 0 <= e && e <= 1
                            });
                        ...
                        var f = c[d[p]], g = h(e, t, f);
                        if (null != g) {
                            var v = f[5], y = f[3], m = f[1], b = gt(v, y, m, g);
            ...
            return this.nodeShapes["bottom-round-rectangle"] = this.nodeShapes.bottomroundrectangle = {
                ...
                intersectLine: function (e, t, n, r, i, a, o) {
                    var s = t - (r / 2 + o), l = Ht(i, a, e, t, e - (n / 2 + o), s, e + (n / 2 + o), s, !1);
                    return l.length > 0 ? l : _t(i, a, e, t, n, r, o)
                },
                checkPoint: function (e, t, n, r, i, a, o) {
                    var s = Qt(r, i), l = 2 * s;
                    if (Ft(e, t, this.points, a, o, r, i - l, [0, -1], n)) return !0;
                    if (Ft(e, t, this.points, a, o, r - l, i, [0, -1], n)) return !0;
                    var u = r / 2 + 2 * n, c = i / 2 + 2 * n;
                    return !!Rt(e, t, [a - u, o - c, a - u, o, a + u, o, a + u, o - c]) || (!!Yt(e, t, l, l, a + r / 2 - s, o + i / 2 - s, n) || !!Yt(e, t, l, l, a - r / 2 + s, o + i / 2 - s, n))
                }
            }
            ...
            var n = new Array(20), r = $t(5, 0), i = $t(5, Math.PI / 5), a = .5 * (3 - Math.sqrt(5));
            a *= 1.57;
            for (var o = 0; o < i.length / 2; o++) i[2 * o] *= a, i[2 * o + 1] *= a;
            for (o = 0; o < 5; o++) n[4 * o] = r[2 * o], n[4 * o + 1] = r[2 * o + 1], n[4 * o + 2] = i[2 * o], n[4 * o + 3] = i[2 * o + 1];
            n = Ut(n), this.generatePolygon("star", n), this.generatePolygon("vee", [-1, -1, 0, -.333, 1, -1, 0, 1]), this.generatePolygon("rhomboid", [-1, -1, .333, -1, 1, 1, -.333, 1]), this.nodeShapes.concavehexagon = this.generatePolygon("concave-hexagon", [-1, -.95, -.75, 0, -1, .95, 1, .95, .75, 0, 1, -.95]), this.generatePolygon("tag", [-1, -1, .25, -1, 1, 0, .25, 1, -1, 1]), e.makePolygon = function (e) {
    ...
    is.clientFunctions = ["redrawHint", "render", "renderTo", "matchCanvasSize", "nodeShapeImpl", "arrowShapeImpl"], is.init = function (e) {
        var t = this;
        t.options = e, t.cy = e.cy;
        var n = t.container = e.cy.container();
        if (a) {
            var r = a.document, i = r.head, o = "__________cytoscape_container",
    ...
    }, is.isHeadless = function () {
        return !1
    }, [Ao, $o, Qo, Jo, es, ts].forEach(function (e) {
        I(is, e)
    });
    var as = function (e) {
        return function () {
            ...
            if (!t.dequeueingSetup) {
                ...
                n.beforeRender(function (i, a) {
                    var o = se(), s = n.averageRedrawTime, l = n.lastRedrawTime, u = [], c = n.cy.extent(),
                        h = n.getPixelRatio();
                    for (i || n.flushRenderedStyleQueue(); ;) {
                        var d = se(), p = d - o, f = d - a;
                        if (l < 1e3 / 60) {
                            var g = 1e3 / 60 - (i ? s : 0);
    ...
    }(), ss = {dequeue: "dequeue", downscale: "downscale", highQuality: "highQuality"}, ls = Me({
        getKey: null,
        ...
        var n = ls(t);
        I(this, n), this.lookup = new os(n.getKey, n.doesEleInvalidateKey), this.setupDequeueing()
    }, cs = us.prototype;
    cs.reasons = ss, cs.getTextureQueue = function (e) {
        return this.eleImgCaches = this.eleImgCaches || {}, this.eleImgCaches[e] = this.eleImgCaches[e] || []
    }, cs.getRetiredTextureQueue = function (e) {
        var t = this.eleImgCaches.retired = this.eleImgCaches.retired || {};
        return t[e] = t[e] || []
    }, cs.getElementQueue = function () {
        return this.eleCacheQueue = this.eleCacheQueue || new Ve(function (e, t) {
            return t.reqs - e.reqs
        })
    }, cs.getElementKeyToQueue = function () {
        return this.eleKeyToCacheQueue = this.eleKeyToCacheQueue || {}
    }, cs.getElement = function (e, t, n, r, i) {
        ...
        if (null == r && (r = Math.ceil(ct(s * n))), r < -4) r = -4; else if (s >= 7.99 || r > 3) return null;
        var u = Math.pow(2, r), c = t.h * u, h = t.w * u, d = o.eleTextBiggerThanMin(e, u);
        ...
        }, x = i && i === ss.dequeue, w = i && i === ss.highQuality, E = i && i === ss.downscale, k = r + 1; k <= 3; k++) {
            var C = l.get(e, k);
            if (C) {
                m = C;
                break
        ...
        if (v.context.setTransform(1, 0, 0, 1, 0, 0), v.context.clearRect(v.usedWidth, 0, h, p), b(S)) D(); else if (b(m)) {
            if (!w) return a.queueElement(e, m.level - 1), m;
            for (var P = m.level; P > r; P--) S = a.getElement(e, t, n, P, ss.downscale);
            D()
        } else {
            var T;
    ...
    }, cs.invalidateElements = function (e) {
        for (var t = 0; t < e.length; t++) this.invalidateElement(e[t])
    }, cs.invalidateElement = function (e) {
        var t = this.lookup, n = [];
        if (t.isInvalid(e)) {
            for (var r = -4; r <= 3; r++) {
    ...
    }, cs.recycleTexture = function (e, t) {
        ...
        for (var t = this.getElementQueue(), n = this.getElementKeyToQueue(), r = [], i = this.lookup, a = 0; a < 1 && t.size() > 0; a++) {
            ...
            if (n[s] = null, !u) {
                ...
                this.getElement(l, c, e, o.level, ss.dequeue)
            }
        }
        return r
    }, cs.removeFromQueue = function (e) {
    ...
    }, cs.onDequeue = function (e) {
        this.onDequeues.push(e)
    }, cs.offDequeue = function (e) {
        Be(this.onDequeues, e)
    }, cs.setupDequeueing = as({
    ...
    }, ds = hs.prototype, ps = 0, fs = Math.pow(2, 53) - 1;
    ds.makeLayer = function (e, t) {
    ...
    }, ds.getLayers = function (e, t, n) {
        var r = this, i = r.renderer.cy.zoom(), a = r.firstGet;
        if (r.firstGet = !1, null == n) if ((n = Math.ceil(ct(i * t))) < -4) n = -4; else if (i >= 3.99 || n > 2) return null;
        ...
        var h = function (t) {
            ...
            if (function () {
                if (!o) {
                    o = bt();
                    for (var t = 0; t < e.length; t++) Et(o, e[t].boundingBox())
                }
        ...
        for (var d = null, p = e.length / 1, f = !a, g = 0; g < e.length; g++) {
            ...
            if (b) d = b; else {
                if ((!d || d.eles.length >= p || !Bt(d.bb, v.boundingBox())) && !(d = h({
                    insert: !0,
                    after: d
                }))) return null;
        ...
        return s || (f ? null : c)
    }, ds.getEleLevelForLayerLevel = function (e, t) {
        return e
    }, ds.drawEleInLayer = function (e, t, n, r) {
    ...
    }, ds.levelIsComplete = function (e, t) {
        ...
        return r === t.length
    }, ds.validateLayersElesOrdering = function (e, t) {
        var n = this.layersByLevel[e];
        if (n) for (var r = 0; r < n.length; r++) {
    ...
    }, ds.updateElementsInLayers = function (e, t) {
        for (var n = b(e[0]), r = 0; r < e.length; r++) for (var i = n ? null : e[r], a = n ? e[r] : e[r].ele, o = a._private.rscratch, s = o.imgLayerCaches = o.imgLayerCaches || {}, l = -4; l <= 2; l++) {
            var u = s[l];
            u && (i && this.getEleLevelForLayerLevel(u.level) !== i.level || t(u, a, i))
        }
    }, ds.haveLayers = function () {
    ...
    }, ds.refineElementTextures = function (e) {
        var t = this;
    ...
    }, ds.enqueueElementRefinement = function (e) {
        this.eleTxrDeqs.merge(e), this.scheduleElementRefinement()
    }, ds.queueLayer = function (e, t) {
        ...
        return n
    }, ds.applyLayerReplacement = function (e) {
    ...
    }, ds.requestRedraw = ne(function () {
        var e = this.renderer;
        e.redrawHint("eles", !0), e.redrawHint("drag", !0), e.redraw()
    }, 100), ds.setupDequeueing = as({
    ...
    vs.arrowShapeImpl = function (e) {
        return (gs || (gs = {
            polygon: ys,
            "triangle-backcurve": ms,
            "triangle-tee": bs,
            "triangle-cross": bs,
            circle: xs
        }))[e]
    ...
    var ws = {
        ...
        }, drawCachedElementPortion: function (e, t, n, r, i, a, o) {
            var s = this, l = n.getBoundingBox(t);
            if (0 !== l.w && 0 !== l.h) {
                var u = n.getElement(t, l, r, i, a);
                if (null != u) {
                    var c = t.effectiveOpacity();
                    if (0 === c) return;
                    var h, d, p, f, g, v, y = o(s, t), m = l.x1, b = l.y1, x = l.w, w = l.h;
                    if (0 !== y) {
                        var E = n.getRotationPoint(t);
                        p = E.x, f = E.y, e.translate(p, f), e.rotate(y), (g = s.getImgSmoothing(e)) || s.setImgSmoothing(e, !0);
                        var k = n.getRotationOffset(t);
                        h = k.x, d = k.y
                    } else h = m, d = b;
                    1 !== c && (v = e.globalAlpha, e.globalAlpha = v * c), e.drawImage(u.texture.canvas, u.x, 0, u.width, u.height, h, d, x, w), 1 !== c && (e.globalAlpha = v), 0 !== y && (e.rotate(-y), e.translate(-p, -f), g || s.setImgSmoothing(e, !1))
    ...
    ws.drawCachedElement = function (e, t, n, r, i, a) {
        var o = this, s = o.data, l = s.eleTxrCache, u = s.lblTxrCache, c = s.slbTxrCache, h = s.tlbTxrCache,
            d = t.boundingBox(), p = !0 === a ? l.reasons.highQuality : null;
        0 !== d.w && 0 !== d.h && t.visible() && (r && !Pt(d, r) || (o.drawCachedElementPortion(e, t, l, n, i, p, Es), o.drawCachedElementPortion(e, t, u, n, i, p, ks), t.isEdge() && (o.drawCachedElementPortion(e, t, c, n, i, p, Cs), o.drawCachedElementPortion(e, t, h, n, i, p, Ss)), o.drawElementOverlay(e, t)))
    }, ws.drawElements = function (e, t) {
        for (var n = 0; n < t.length; n++) {
            var r = t[n];
            this.drawElement(e, r)
        }
    }, ws.drawCachedElements = function (e, t, n, r) {
        for (var i = 0; i < t.length; i++) {
            var a = t[i];
            this.drawCachedElement(e, a, n, r)
        }
    }, ws.drawCachedNodes = function (e, t, n, r) {
        for (var i = 0; i < t.length; i++) {
            var a = t[i];
            a.isNode() && this.drawCachedElement(e, a, n, r)
        }
    }, ws.drawLayeredElements = function (e, t, n, r) {
    ...
    var Ds = {
        drawEdge: function (e, t, n) {
            ...
            if (t.visible() && !s.badLine && null != s.allpts && !isNaN(s.allpts[0])) {
                var l;
                n && (l = n, e.translate(-l.x1, -l.y1));
                var u = a ? t.pstyle("opacity").value : 1, c = t.pstyle("line-style").value,
                    h = t.pstyle("width").pfValue, d = t.pstyle("line-cap").value, p = function () {
                ...
                if (e.lineJoin = "round", "yes" === t.pstyle("ghost").value) {
                    var g = t.pstyle("ghost-offset-x").pfValue, v = t.pstyle("ghost-offset-y").pfValue,
                        y = t.pstyle("ghost-opacity").value, m = u * y;
            ...
            if (t.visible()) {
                ...
                if (0 !== n) {
                    var r = this, i = r.usePaths(), a = t._private.rscratch,
                        o = 2 * t.pstyle("overlay-padding").pfValue, s = t.pstyle("overlay-color").value;
            ...
            var i, a = e._private.rscratch, o = t, s = !1, l = this.usePaths(),
                u = e.pstyle("line-dash-pattern").pfValue, c = e.pstyle("line-dash-offset").pfValue;
            if (l) {
                var h = n.join("$");
            ...
            if (!(isNaN(r) || null == r || isNaN(i) || null == i || isNaN(a) || null == a)) {
                ...
                if ("none" !== s) {
                    var l = "hollow" === t.pstyle(n + "-arrow-fill").value ? "both" : "filled",
                        u = t.pstyle(n + "-arrow-fill").value, c = t.pstyle("width").pfValue,
            ...
            var l, u = this, c = this.usePaths() && "triangle-cross" !== i, h = !1, d = t, p = {x: a, y: o},
                f = e.pstyle("arrow-scale").value, g = this.getArrowWidth(r, f), v = u.arrowShapes[i];
            if (c) {
                var y = u.arrowPathCache = u.arrowPathCache || [], m = he(i), b = y[m];
        ...
        safeDrawImage: function (e, t, n, r, i, a, o, s, l, u) {
            ...
            var a = this, o = n.position(), s = o.x, l = o.y, u = n.cy().style(), c = u.getIndexedStyle.bind(u),
                h = c(n, "background-fit", "value", r), d = c(n, "background-repeat", "value", r), p = n.width(),
                ...
                m = n._private.rscratch, b = "node" === n.pstyle("background-clip").value,
                x = c(n, "background-image-opacity", "value", r) * i, w = t.width || t.cachedW,
            ...
            if ("auto" !== c(n, "background-width", "value", r) && (k = "%" === c(n, "background-width", "units", r) ? c(n, "background-width", "pfValue", r) * v : c(n, "background-width", "pfValue", r)), "auto" !== c(n, "background-height", "value", r) && (C = "%" === c(n, "background-height", "units", r) ? c(n, "background-height", "pfValue", r) * y : c(n, "background-height", "pfValue", r)), 0 !== k && 0 !== C) {
                if ("contain" === h) k *= S = Math.min(v / k, y / C), C *= S; else if ("cover" === h) {
                    var S;
                    k *= S = Math.max(v / k, y / C), C *= S
                }
                var D = s - v / 2, P = c(n, "background-position-x", "units", r),
                    T = c(n, "background-position-x", "pfValue", r);
                D += "%" === P ? (v - k) * T : T;
                var M = c(n, "background-offset-x", "units", r), B = c(n, "background-offset-x", "pfValue", r);
                D += "%" === M ? (v - k) * B : B;
                var _ = l - y / 2, N = c(n, "background-position-y", "units", r),
                    I = c(n, "background-position-y", "pfValue", r);
                _ += "%" === N ? (y - C) * I : I;
                var z = c(n, "background-offset-y", "units", r), L = c(n, "background-offset-y", "pfValue", r);
                _ += "%" === z ? (y - C) * L : L, m.pathCache && (D -= s, _ -= l, s = 0, l = 0);
                var A = e.globalAlpha;
                if (e.globalAlpha = x, "no-repeat" === d) b && (e.save(), m.pathCache ? e.clip(m.pathCache) : (a.nodeShapes[a.getNodeShape(n)].draw(e, s, l, v, y), e.clip())), a.safeDrawImage(e, t, 0, 0, w, E, D, _, k, C), b && e.restore(); else {
    ...
    Ts.eleTextBiggerThanMin = function (e, t) {
        if (!t) {
            var n = e.cy().zoom(), r = this.getPixelRatio(), i = Math.ceil(ct(n * r));
            t = Math.pow(2, i)
        }
        return !(e.pstyle("font-size").pfValue * t < e.pstyle("min-zoomed-font-size").pfValue)
    }, Ts.drawElementText = function (e, t, n, r, i) {
        var a = !(arguments.length > 5 && void 0 !== arguments[5]) || arguments[5], o = this;
        if (null == r) {
            if (!o.eleTextBiggerThanMin(t)) return
        } else if (!1 === r) return;
        if (t.isNode()) {
            ...
            var u = t.pstyle("label"), c = t.pstyle("source-label"), h = t.pstyle("target-label");
    ...
    }, Ts.setupTextStyle = function (e, t) {
        var n = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2], r = t.pstyle("font-style").strValue,
            ...
            o = t.pstyle("font-weight").strValue, s = t.pstyle("text-opacity").value * (n ? t.effectiveOpacity() : 1),
        ...
        if (0 !== s && 0 !== t.pstyle("text-opacity").value) {
            "main" === n && (n = null);
            var l, u, c = Ne(o, "labelX", n), h = Ne(o, "labelY", n), d = this.getLabelText(t, n);
            if (null != d && "" !== d && !isNaN(c) && !isNaN(h)) {
                ...
                switch (b && (x = "center", w = "center"), c += y, h += m, 0 !== (p = r ? this.getTextAngle(t, n) : 0) && (l = c, u = h, e.translate(l, u), e.rotate(p), c = 0, h = 0), w) {
                    case"top":
                        break;
                    case"center":
                        h += v / 2;
                ...
                if (E > 0 || C > 0 && k > 0) {
                    ...
                    var P = h - v - S, T = g + 2 * S, M = v + 2 * S;
                    if (E > 0) {
                        var B = e.fillStyle, _ = t.pstyle("text-background-color").value;
                        e.fillStyle = "rgba(" + _[0] + "," + _[1] + "," + _[2] + "," + E * s + ")", "roundrectangle" == t.pstyle("text-background-shape").strValue ? function (e, t, n, r, i) {
                        ...
                        }(e, D, P, T, M, 2) : e.fillRect(D, P, T, M), e.fillStyle = B
                    }
                    if (C > 0 && k > 0) {
                        var N = e.strokeStyle, I = e.lineWidth, z = t.pstyle("text-border-color").value,
                            L = t.pstyle("text-border-style").value;
                        if (e.strokeStyle = "rgba(" + z[0] + "," + z[1] + "," + z[2] + "," + k * s + ")", e.lineWidth = C, e.setLineDash) switch (L) {
                            case"dotted":
                                e.setLineDash([1, 1]);
                                break;
                            case"dashed":
                        ...
                        if (e.strokeRect(D, P, T, M), "double" === L) {
                            var A = C / 2;
                            e.strokeRect(D + A, P + A, T - 2 * A, M - 2 * A)
                        }
                        e.setLineDash && e.setLineDash([]), e.lineWidth = I, e.strokeStyle = N
                    }
                }
                var O = 2 * t.pstyle("text-outline-width").pfValue;
                if (O > 0 && (e.lineWidth = O), "wrap" === t.pstyle("text-wrap").value) {
                    var R = Ne(o, "labelWrapCachedLines", n), F = a.rscratch.labelLineHeight, V = g / 2,
                        q = this.getLabelJustification(t);
                    switch ("auto" === q || ("left" === x ? "left" === q ? c += -g : "center" === q && (c += -V) : "center" === x ? "left" === q ? c += -V : "right" === q && (c += V) : "right" === x && ("center" === q ? c += V : "right" === q && (c += g))), w) {
                        case"top":
                            h -= (R.length - 1) * F;
                            break;
                        case"center":
                    ...
                    for (var j = 0; j < R.length; j++) O > 0 && e.strokeText(R[j], c, h), e.fillText(R[j], c, h), h += F
                } else O > 0 && e.strokeText(d, c, h), e.fillText(d, c, h);
    ...
    var Ms = {
        drawNode: function (e, t, n) {
            var r, i, a = !(arguments.length > 3 && void 0 !== arguments[3]) || arguments[3],
                ...
                c = u.rscratch, h = t.position();
            if (v(h.x) && v(h.y) && t.visible()) {
                var d, p, f = s ? t.effectiveOpacity() : 1, g = l.usePaths(), y = !1, m = t.padding();
                ...
                var D = t.pstyle("background-blacken").value, P = t.pstyle("border-width").pfValue,
                    T = t.pstyle("background-opacity").value * f, M = t.pstyle("border-color").value,
                    B = t.pstyle("border-style").value, _ = t.pstyle("border-opacity").value * f;
                e.lineJoin = "miter";
                var N = function () {
                ...
                }, z = t.pstyle("shape").strValue, L = t.pstyle("shape-polygon-points").pfValue;
                if (g) {
                    e.translate(h.x, h.y);
                    var A = l.nodePathCache = l.nodePathCache || [],
                        O = de("polygon" === z ? z + "," + L.join(",") : z, "" + i, "" + r), R = A[O];
                    null != R ? (d = R, y = !0, c.pathCache = d) : (d = new Path2D, A[O] = c.pathCache = d)
                }
                var F = function () {
                    if (!y) {
                        var n = h;
                        g && (n = {x: 0, y: 0}), l.nodeShapes[l.getNodeShape(t)].draw(d || e, n.x, n.y, r, i)
                    }
                    g ? e.fill(d) : e.fill()
                }, V = function () {
                ...
                if ("yes" === t.pstyle("ghost").value) {
                    var X = t.pstyle("ghost-offset-x").pfValue, W = t.pstyle("ghost-offset-y").pfValue,
                        H = t.pstyle("ghost-opacity").value, K = H * f;
                    e.translate(X, W), N(H * T), F(), V(K), q(0 !== D || 0 !== P), j(K), I(H * _), Y(), e.translate(-X, -W)
                }
                N(), F(), V(), q(0 !== D || 0 !== P), j(), I(), Y(), g && e.translate(-h.x, -h.y), l.drawElementText(e, t, null, a), o && l.drawNodeOverlay(e, t, h, r, i), n && e.translate(p.x1, p.y1)
            }
        }, drawNodeOverlay: function (e, t, n, r, i) {
            if (t.visible()) {
                var a = t.pstyle("overlay-padding").pfValue, o = t.pstyle("overlay-opacity").value,
            ...
            for (var d = 1; d <= i.pieBackgroundN; d++) {
                var p = t.pstyle("pie-" + d + "-background-size").value,
                    ...
                    g = t.pstyle("pie-" + d + "-background-opacity").value * n, v = p / 100;
                v + h > 1 && (v = 1 - h);
                var y = 1.5 * Math.PI + 2 * Math.PI * h, m = y + 2 * Math.PI * v;
                0 === p || h >= 1 || h + v > 1 || (e.beginPath(), e.moveTo(o, s), e.arc(o, s, c, y, m), e.closePath(), this.colorFillStyle(e, f[0], f[1], f[2], g), e.fill(), h += v)
            }
        }
    }, Bs = {};
    Bs.getPixelRatio = function () {
        ...
        if ("radial-gradient" === r) if (n.isEdge()) {
            var u = n.sourceEndpoint(), c = n.targetEndpoint(), h = n.midpoint(), d = dt(u, h), p = dt(c, h);
            a = e.createRadialGradient(h.x, h.y, 0, h.x, h.y, Math.max(d, p))
        } else {
            var f = o ? {x: 0, y: 0} : n.position(), g = n.width(), v = n.height();
            ...
            var b = o ? {x: 0, y: 0} : n.position(), x = n.width() / 2, w = n.height() / 2;
        ...
        return a
    }, Bs.gradientFillStyle = function (e, t, n, r) {
        var i = this.createGradientStyleFor(e, "background", t, n, r);
        if (!i) return null;
        e.fillStyle = i
    }, Bs.colorFillStyle = function (e, t, n, r, i) {
        e.fillStyle = "rgba(" + t + "," + n + "," + r + "," + i + ")"
    }, Bs.eleFillStyle = function (e, t, n) {
    ...
    }, Bs.gradientStrokeStyle = function (e, t, n, r) {
        var i = this.createGradientStyleFor(e, "line", t, n, r);
        if (!i) return null;
        e.strokeStyle = i
    }, Bs.colorStrokeStyle = function (e, t, n, r, i) {
        e.strokeStyle = "rgba(" + t + "," + n + "," + r + "," + i + ")"
    }, Bs.eleStrokeStyle = function (e, t, n) {
        ...
        var t = (e = e || Te()).forcedContext, n = e.drawAllLayers, r = e.drawOnlyNodeLayer, i = e.forcedZoom,
            ...
            d = void 0 !== e.motionBlur ? e.motionBlur : o.motionBlur, p = o.motionBlurPxRatio,
            f = l.hasCompoundNodes(), g = o.hoverData.draggingEles,
            v = !(!o.hoverData.selecting && !o.touchData.selecting), y = d = d && !t && o.motionBlurEnabled && !v;
        ...
        if (o.showFps || !r && c[o.SELECT_BOX] && !n) {
            ...
            if (u.bgActivePosistion && !o.hoverData.selecting) {
                ...
                M.fillStyle = "rgba(" + m.core("active-bg-color").value[0] + "," + m.core("active-bg-color").value[1] + "," + m.core("active-bg-color").value[2] + "," + m.core("active-bg-opacity").value + ")", M.beginPath(), M.arc(F.x, F.y, m.core("active-bg-size").pfValue / b, 0, 2 * Math.PI), M.fill()
            }
            var V = o.lastRedrawTime;
            if (o.showFps && V) {
                V = Math.round(V);
                var q = Math.round(1e3 / V);
                M.setTransform(1, 0, 0, 1, 0, 0), M.fillStyle = "rgba(255, 0, 0, 0.75)", M.strokeStyle = "rgba(255, 0, 0, 0.75)", M.lineWidth = 1, M.fillText("1 frame = " + V + " ms = " + q + " fps", 0, 20);
    ...
    for (var _s = {
        drawPolygonPath: function (e, t, n, r, i, a) {
            ...
            var a = r / 2, o = i / 2, s = t - a, l = t + a, u = n - o, c = n + o, h = en(r, i), d = h.widthOffset,
                p = h.heightOffset, f = h.ctrlPtOffsetPct * d;
    ...
    }, Ns = Math.sin(0), Is = Math.cos(0), zs = {}, Ls = {}, As = Math.PI / 40, Os = 0 * Math.PI; Os < 2 * Math.PI; Os += As) zs[Os] = Math.sin(Os), Ls[Os] = Math.cos(Os);
    _s.drawEllipsePath = function (e, t, n, r, i) {
        if (e.beginPath && e.beginPath(), e.ellipse) e.ellipse(t, n, r / 2, i / 2, 0, 0, 2 * Math.PI); else for (var a, o, s = r / 2, l = i / 2, u = 0 * Math.PI; u < 2 * Math.PI; u += As) a = t - s * zs[u] * Ns + s * Ls[u] * Is, o = n + l * Ls[u] * Ns + l * zs[u] * Is, 0 === u ? e.moveTo(a, o) : e.lineTo(a, o);
        e.closePath()
    };
    var Rs = {};
    ...
    Rs.createBuffer = function (e, t) {
        var n = document.createElement("canvas");
        return n.width = e, n.height = t, [n, n.getContext("2d")]
    }, Rs.bufferCanvasImage = function (e) {
        var t = this.cy, n = t.mutableElements().boundingBox(), r = this.findContainerClientCoords(),
            i = e.full ? Math.ceil(n.w) : r[2], a = e.full ? Math.ceil(n.h) : r[3], o = v(e.maxWidth) || v(e.maxHeight),
        ...
        if (i > 0 && a > 0) {
            ...
            if (e.full) d.translate(-n.x1 * l, -n.y1 * l), d.scale(l, l), this.drawElements(d, p), d.scale(1 / l, 1 / l), d.translate(n.x1 * l, n.y1 * l); else {
        ...
        return Vs(e, this.bufferCanvasImage(e), "image/png")
    }, Rs.jpg = function (e) {
        return Vs(e, this.bufferCanvasImage(e), "image/jpeg")
    };
    var qs = {
    ...
    }, js = Xs, Ys = Xs.prototype;

    function Xs(e) {
        var t = this;
        t.data = {
            canvases: new Array(Ys.CANVAS_LAYERS),
            contexts: new Array(Ys.CANVAS_LAYERS),
            canvasNeedsRedraw: new Array(Ys.CANVAS_LAYERS),
            bufferCanvases: new Array(Ys.BUFFER_COUNT),
            bufferContexts: new Array(Ys.CANVAS_LAYERS)
        };
        ...
        for (var a = 0; a < Ys.CANVAS_LAYERS; a++) {
            var o = t.data.canvases[a] = document.createElement("canvas");
            t.data.contexts[a] = o.getContext("2d"), Object.keys(i).forEach(function (e) {
                o.style[e] = i[e]
            }), o.style.position = "absolute", o.setAttribute("data-id", "layer" + a), o.style.zIndex = String(Ys.CANVAS_LAYERS - a), t.data.canvasContainer.appendChild(o), t.data.canvasNeedsRedraw[a] = !1
        }
        t.data.topCanvas = t.data.canvases[0], t.data.canvases[Ys.NODE].setAttribute("data-id", "layer" + Ys.NODE + "-node"), t.data.canvases[Ys.SELECT_BOX].setAttribute("data-id", "layer" + Ys.SELECT_BOX + "-selectbox"), t.data.canvases[Ys.DRAG].setAttribute("data-id", "layer" + Ys.DRAG + "-drag");
        for (a = 0; a < Ys.BUFFER_COUNT; a++) t.data.bufferCanvases[a] = document.createElement("canvas"), t.data.bufferContexts[a] = t.data.bufferCanvases[a].getContext("2d"), t.data.bufferCanvases[a].style.position = "absolute", t.data.bufferCanvases[a].setAttribute("data-id", "buffer" + a), t.data.bufferCanvases[a].style.zIndex = String(-a - 1), t.data.bufferCanvases[a].style.visibility = "hidden";
        t.pathsEnabled = !0;
        var s = bt(), l = function (e) {
            ...
            return {x: e.x + t.pstyle("text-margin-x").pfValue, y: e.y + t.pstyle("text-margin-y").pfValue}
        }, g = function (e, t, n) {
            var r = e[0]._private.rscratch;
            return {x: r[t], y: r[n]}
        }, v = t.data.eleTxrCache = new us(t, {
            getKey: function (e) {
    ...
    Ys.CANVAS_LAYERS = 3, Ys.SELECT_BOX = 0, Ys.DRAG = 1, Ys.NODE = 2, Ys.BUFFER_COUNT = 3, Ys.TEXTURE_BUFFER = 0, Ys.MOTIONBLUR_BUFFER_NODE = 1, Ys.MOTIONBLUR_BUFFER_DRAG = 2, Ys.redrawHint = function (e, t) {
        var n = this;
        switch (e) {
            case"eles":
                n.data.canvasNeedsRedraw[Ys.NODE] = t;
                break;
            case"drag":
                n.data.canvasNeedsRedraw[Ys.DRAG] = t;
                break;
            case"select":
                n.data.canvasNeedsRedraw[Ys.SELECT_BOX] = t
        }
    };
    var Ws = "undefined" != typeof Path2D;
    Ys.path2dEnabled = function (e) {
        if (void 0 === e) return this.pathsEnabled;
        this.pathsEnabled = !!e
    }, Ys.usePaths = function () {
        return Ws && this.pathsEnabled
    }, Ys.setImgSmoothing = function (e, t) {
    ...
    }, Ys.makeOffscreenCanvas = function (t, n) {
        var r;
    ...
    }, [vs, ws, Ds, Ps, Ts, Ms, Bs, _s, Rs, qs].forEach(function (e) {
        I(Ys, e)
    });
    var Hs = [{type: "layout", extensions: Io}, {
        type: "renderer",
        extensions: [{name: "null", impl: zo}, {name: "base", impl: rs}, {name: "canvas", impl: js}]
    }], Ks = {}, Gs = {};
    ...
    function Zs(e, t, n) {
        ...
        if ("core" === e) {
            ...
            I(o, {
                createEmitter: function () {
                    return this._private.emitter = new qi(d, this), this
                }, emitter: function () {
                    return this._private.emitter
                }, on: function (e, t) {
            ...
            }), cr.eventAliasesOn(o), r = a
        } else if ("renderer" === e && "null" !== t && "base" !== t) {
            var p = Us("renderer", "base"), f = p.prototype, v = n, y = n.prototype, m = function () {
        ...
        return A({map: Ks, keys: [e, t], value: r})
    }

    function Us(e, t) {
        return O({map: Ks, keys: [e, t]})
    }

    var $s = function () {
        return 2 === arguments.length ? Us.apply(null, arguments) : 3 === arguments.length ? Zs.apply(null, arguments) : 4 === arguments.length ? function (e, t, n, r) {
            return O({map: Gs, keys: [e, t, n, r]})
        }.apply(null, arguments) : 5 === arguments.length ? function (e, t, n, r, i) {
            return A({map: Gs, keys: [e, t, n, r], value: i})
        }.apply(null, arguments) : void Ee("Invalid extension access syntax")
    };
    ao.prototype.extension = $s, Hs.forEach(function (e) {
        e.extensions.forEach(function (t) {
            Zs(e.type, t.name, t.impl)
        })
    });
    var Qs = function e() {
    ...
    Js.instanceString = function () {
        return "stylesheet"
    }, Js.selector = function (e) {
        ...
        if (d(e)) this[n].properties.push({
            name: e,
            value: t
        }); else if (g(e)) for (var r = e, i = Object.keys(r), a = 0; a < i.length; a++) {
            var o = i[a], s = r[o];
            if (null != s) {
                var l = to.properties[o] || to.properties[T(o)];
                if (null != l) {
                    var u = l.name, c = s;
        ...
        return this
    }, Js.style = Js.css, Js.generateStyle = function (e) {
        var t = new to(e);
        return this.appendToStyle(t)
    }, Js.appendToStyle = function (e) {
        for (var t = 0; t < this.length; t++) {
    ...
    var el = function (e) {
        return void 0 === e && (e = {}), g(e) ? new ao(e) : d(e) ? $s.apply($s, arguments) : void 0
    };
    return el.use = function (e) {
        var t = Array.prototype.slice.call(arguments, 1);
        return t.unshift(el), e.apply(null, t), this
    }, el.warnings = function (e) {
        return ke(e)
    }, el.version = "3.6.0", el.stylesheet = el.Stylesheet = Qs, el
});
